...
#nullable restore
        ...
        public CodespacesPostRequestBodyMember2_geo? Geo { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CodespacesPostRequestBodyMember2_pull_request? PullRequest { get; set; }
#nullable restore
#else
        public CodespacesPostRequestBodyMember2_pull_request PullRequest { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="CodespacesPostRequestBodyMember2"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="CodespacesPostRequestBodyMember2"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static CodespacesPostRequestBodyMember2 CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new CodespacesPostRequestBodyMember2();
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<CodespacesPostRequestBodyMember2_geo>("geo", Geo);
            writer.WriteIntValue("idle_timeout_minutes", IdleTimeoutMinutes);
            writer.WriteStringValue("location", Location);
            writer.WriteStringValue("machine", Machine);
            writer.WriteObjectValue<CodespacesPostRequestBodyMember2_pull_request>("pull_request", PullRequest);
