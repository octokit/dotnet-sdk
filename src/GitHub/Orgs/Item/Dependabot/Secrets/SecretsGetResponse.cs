...
#nullable enable
        public List<OrganizationDependabotSecret>? Secrets { get; set; }
#nullable restore
#else
        public List<OrganizationDependabotSecret> Secrets { get; set; }
#endif
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                {"secrets", n => { Secrets = n.GetCollectionOfObjectValues<OrganizationDependabotSecret>(OrganizationDependabotSecret.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<OrganizationDependabotSecret>("secrets", Secrets);
