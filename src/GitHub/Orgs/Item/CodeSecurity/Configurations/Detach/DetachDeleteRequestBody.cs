...
namespace GitHub.Orgs.Item.CodeSecurity.Configurations.Detach {
    ...
    public class DetachDeleteRequestBody : IParsable 
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="DetachDeleteRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static DetachDeleteRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new DetachDeleteRequestBody();
        }
        /// <summary>
