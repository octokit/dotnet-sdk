...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="CardsPostRequestBodyMember2"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="CardsPostRequestBodyMember2"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static CardsPostRequestBodyMember2 CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new CardsPostRequestBodyMember2();
        }
        /// <summary>
