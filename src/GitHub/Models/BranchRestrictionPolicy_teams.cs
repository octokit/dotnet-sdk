...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="BranchRestrictionPolicy_teams"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="BranchRestrictionPolicy_teams"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static BranchRestrictionPolicy_teams CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new BranchRestrictionPolicy_teams();
        }
        /// <summary>
