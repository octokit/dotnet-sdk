...
namespace GitHub.Models {
    ...
    public class RepositoryAdvisoryUpdate_credits : IParsable 
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="RepositoryAdvisoryUpdate_credits"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static RepositoryAdvisoryUpdate_credits CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new RepositoryAdvisoryUpdate_credits();
        }
        /// <summary>
