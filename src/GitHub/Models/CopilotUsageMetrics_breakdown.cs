...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="CopilotUsageMetrics_breakdown"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="CopilotUsageMetrics_breakdown"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static CopilotUsageMetrics_breakdown CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new CopilotUsageMetrics_breakdown();
        }
        /// <summary>
