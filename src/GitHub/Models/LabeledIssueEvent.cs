...
namespace GitHub.Models {
    ...
    /// Labeled Issue Event
    /// </summary>
    public class LabeledIssueEvent : IAdditionalDataHolder, IParsable 
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public LabeledIssueEvent_label? Label { get; set; }
#nullable restore
#else
        public LabeledIssueEvent_label Label { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="LabeledIssueEvent"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="LabeledIssueEvent"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static LabeledIssueEvent CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new LabeledIssueEvent();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"label", n => { Label = n.GetObjectValue<LabeledIssueEvent_label>(LabeledIssueEvent_label.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<LabeledIssueEvent_label>("label", Label);
