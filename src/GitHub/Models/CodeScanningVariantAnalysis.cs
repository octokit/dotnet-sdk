...
#nullable restore
        ...
        public CodeScanningVariantAnalysis_failure_reason? FailureReason { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<CodeScanningVariantAnalysis_scanned_repositories>? ScannedRepositories { get; set; }
#nullable restore
#else
        public List<CodeScanningVariantAnalysis_scanned_repositories> ScannedRepositories { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CodeScanningVariantAnalysis_skipped_repositories? SkippedRepositories { get; set; }
#nullable restore
#else
        public CodeScanningVariantAnalysis_skipped_repositories SkippedRepositories { get; set; }
#endif
        /// <summary>The status property</summary>
        public CodeScanningVariantAnalysis_status? Status { get; set; }
        ...
        /// <summary>
        /// Instantiates a new <see cref="CodeScanningVariantAnalysis"/> and sets the default values.
        /// </summary>
        ...
        public static CodeScanningVariantAnalysis CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new CodeScanningVariantAnalysis();
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<SimpleRepository>("controller_repo", ControllerRepo);
            writer.WriteDateTimeOffsetValue("created_at", CreatedAt);
            writer.WriteEnumValue<CodeScanningVariantAnalysis_failure_reason>("failure_reason", FailureReason);
            writer.WriteIntValue("id", Id);
            writer.WriteEnumValue<CodeScanningVariantAnalysisLanguage>("query_language", QueryLanguage);
            writer.WriteStringValue("query_pack_url", QueryPackUrl);
            writer.WriteCollectionOfObjectValues<CodeScanningVariantAnalysis_scanned_repositories>("scanned_repositories", ScannedRepositories);
            writer.WriteObjectValue<CodeScanningVariantAnalysis_skipped_repositories>("skipped_repositories", SkippedRepositories);
            writer.WriteEnumValue<CodeScanningVariantAnalysis_status>("status", Status);
