...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="PullRequestSimple_base"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="PullRequestSimple_base"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static PullRequestSimple_base CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new PullRequestSimple_base();
        }
        /// <summary>
