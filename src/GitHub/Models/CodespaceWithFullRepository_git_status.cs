...
namespace GitHub.Models {
    ...
    /// </summary>
    public class CodespaceWithFullRepository_git_status : IAdditionalDataHolder, IParsable 
    {
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="CodespaceWithFullRepository_git_status"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="CodespaceWithFullRepository_git_status"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static CodespaceWithFullRepository_git_status CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new CodespaceWithFullRepository_git_status();
        }
        /// <summary>
