...
namespace GitHub.Models {
    ...
    #pragma warning restore CS1591
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ActionsGetDefaultWorkflowPermissions"/> and sets the default values.
        /// </summary>
        ...
        public static ActionsGetDefaultWorkflowPermissions CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ActionsGetDefaultWorkflowPermissions();
        }
        /// <summary>
