...
namespace GitHub.Models {
    ...
    /// A codespace.
    /// </summary>
    public class CodespaceWithFullRepository : IAdditionalDataHolder, IParsable 
    {
...
#nullable restore
        ...
        public CodespaceWithFullRepository_location? Location { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CodespaceWithFullRepository_runtime_constraints? RuntimeConstraints { get; set; }
#nullable restore
#else
        public CodespaceWithFullRepository_runtime_constraints RuntimeConstraints { get; set; }
#endif
...
#nullable restore
        ...
        public CodespaceWithFullRepository_state? State { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="CodespaceWithFullRepository"/> and sets the default values.
        /// </summary>
        ...
        public static CodespaceWithFullRepository CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new CodespaceWithFullRepository();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"location", n => { Location = n.GetEnumValue<CodespaceWithFullRepository_location>(); } },
                ...
                {"repository", n => { Repository = n.GetObjectValue<FullRepository>(FullRepository.CreateFromDiscriminatorValue); } },
                ...
                {"runtime_constraints", n => { RuntimeConstraints = n.GetObjectValue<CodespaceWithFullRepository_runtime_constraints>(CodespaceWithFullRepository_runtime_constraints.CreateFromDiscriminatorValue); } },
                {"start_url", n => { StartUrl = n.GetStringValue(); } },
                {"state", n => { State = n.GetEnumValue<CodespaceWithFullRepository_state>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<CodespaceWithFullRepository_location>("location", Location);
            ...
            writer.WriteObjectValue<FullRepository>("repository", Repository);
            ...
            writer.WriteObjectValue<CodespaceWithFullRepository_runtime_constraints>("runtime_constraints", RuntimeConstraints);
            writer.WriteStringValue("start_url", StartUrl);
            writer.WriteEnumValue<CodespaceWithFullRepository_state>("state", State);
