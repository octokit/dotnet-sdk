...
namespace GitHub.Models {
    ...
    /// Minimal Repository
    /// </summary>
    public class NullableMinimalRepository : IAdditionalDataHolder, IParsable 
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public GitHub.Models.CodeOfConduct? CodeOfConduct { get; set; }
#nullable restore
#else
        public GitHub.Models.CodeOfConduct CodeOfConduct { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public NullableMinimalRepository_license? License { get; set; }
#nullable restore
#else
        public NullableMinimalRepository_license License { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public NullableMinimalRepository_permissions? Permissions { get; set; }
#nullable restore
#else
        public NullableMinimalRepository_permissions Permissions { get; set; }
#endif
...
#nullable restore
        ...
        public static NullableMinimalRepository CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            ...
            return new NullableMinimalRepository();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"code_of_conduct", n => { CodeOfConduct = n.GetObjectValue<GitHub.Models.CodeOfConduct>(GitHub.Models.CodeOfConduct.CreateFromDiscriminatorValue); } },
                ...
                {"license", n => { License = n.GetObjectValue<NullableMinimalRepository_license>(NullableMinimalRepository_license.CreateFromDiscriminatorValue); } },
                ...
                {"permissions", n => { Permissions = n.GetObjectValue<NullableMinimalRepository_permissions>(NullableMinimalRepository_permissions.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<GitHub.Models.CodeOfConduct>("code_of_conduct", CodeOfConduct);
            ...
            writer.WriteObjectValue<NullableMinimalRepository_license>("license", License);
            ...
            writer.WriteObjectValue<NullableMinimalRepository_permissions>("permissions", Permissions);
