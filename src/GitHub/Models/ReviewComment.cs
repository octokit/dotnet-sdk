...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ReviewComment__links? Links { get; set; }
#nullable restore
#else
        public ReviewComment__links Links { get; set; }
#endif
...
#nullable restore
        ...
        public ReviewComment_side? Side { get; set; }
        /// <summary>The first line of the range for a multi-line comment.</summary>
        public int? StartLine { get; set; }
        /// <summary>The side of the first line of the range for a multi-line comment.</summary>
        public ReviewComment_start_side? StartSide { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ReviewComment"/> and sets the default values.
        /// </summary>
        public ReviewComment()
        {
            AdditionalData = new Dictionary<string, object>();
            Side = ReviewComment_side.RIGHT;
            StartSide = ReviewComment_start_side.RIGHT;
        }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="ReviewComment"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ReviewComment CreateFromDiscriminatorValue(IParseNode parseNode)
        {
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<ReviewComment__links>("_links", Links);
            ...
            writer.WriteEnumValue<ReviewComment_side>("side", Side);
            writer.WriteIntValue("start_line", StartLine);
            writer.WriteEnumValue<ReviewComment_start_side>("start_side", StartSide);
