...
namespace GitHub.Models {
    ...
    /// </summary>
    public class ClassroomAssignmentGrade : IAdditionalDataHolder, IParsable 
    {
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ClassroomAssignmentGrade"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ClassroomAssignmentGrade"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ClassroomAssignmentGrade CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ClassroomAssignmentGrade();
        }
        /// <summary>
