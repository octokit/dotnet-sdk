...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CodeScanningVariantAnalysisRepository? Repository { get; set; }
#nullable restore
#else
        public CodeScanningVariantAnalysisRepository Repository { get; set; }
#endif
        ...
        /// <summary>
        /// Instantiates a new <see cref="CodeScanningVariantAnalysis_scanned_repositories"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="CodeScanningVariantAnalysis_scanned_repositories"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static CodeScanningVariantAnalysis_scanned_repositories CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new CodeScanningVariantAnalysis_scanned_repositories();
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<CodeScanningVariantAnalysisRepository>("repository", Repository);
