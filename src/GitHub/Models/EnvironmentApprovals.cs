...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<EnvironmentApprovals_environments>? Environments { get; set; }
#nullable restore
#else
        public List<EnvironmentApprovals_environments> Environments { get; set; }
#endif
        /// <summary>Whether deployment to the environment(s) was approved or rejected or pending (with comments)</summary>
        public EnvironmentApprovals_state? State { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="EnvironmentApprovals"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="EnvironmentApprovals"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static EnvironmentApprovals CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new EnvironmentApprovals();
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<EnvironmentApprovals_environments>("environments", Environments);
            writer.WriteEnumValue<EnvironmentApprovals_state>("state", State);
