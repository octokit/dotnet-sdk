...
#nullable enable
        public List<WorkflowRunUsage_billable_MACOS_job_runs>? JobRuns { get; set; }
#nullable restore
#else
        public List<WorkflowRunUsage_billable_MACOS_job_runs> JobRuns { get; set; }
#endif
        ...
        /// <summary>
        /// Instantiates a new <see cref="WorkflowRunUsage_billable_MACOS"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="WorkflowRunUsage_billable_MACOS"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static WorkflowRunUsage_billable_MACOS CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new WorkflowRunUsage_billable_MACOS();
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<WorkflowRunUsage_billable_MACOS_job_runs>("job_runs", JobRuns);
