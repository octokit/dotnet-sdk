...
namespace GitHub.Models {
    ...
    public class Collaborator_permissions : IAdditionalDataHolder, IParsable 
    #pragma warning restore CS1591
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="Collaborator_permissions"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="Collaborator_permissions"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static Collaborator_permissions CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Collaborator_permissions();
        }
        /// <summary>
