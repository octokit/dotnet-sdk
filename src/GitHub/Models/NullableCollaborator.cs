...
namespace GitHub.Models {
    ...
    /// Collaborator
    /// </summary>
    public class NullableCollaborator : IAdditionalDataHolder, IParsable 
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public NullableCollaborator_permissions? Permissions { get; set; }
#nullable restore
#else
        public NullableCollaborator_permissions Permissions { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="NullableCollaborator"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="NullableCollaborator"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static NullableCollaborator CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new NullableCollaborator();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"permissions", n => { Permissions = n.GetObjectValue<NullableCollaborator_permissions>(NullableCollaborator_permissions.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<NullableCollaborator_permissions>("permissions", Permissions);
