...
namespace GitHub.Models {
    ...
    /// Collaborator
    /// </summary>
    public class Collaborator : IAdditionalDataHolder, IParsable 
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Collaborator_permissions? Permissions { get; set; }
#nullable restore
#else
        public Collaborator_permissions Permissions { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="Collaborator"/> and sets the default values.
        /// </summary>
        public Collaborator()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="Collaborator"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static Collaborator CreateFromDiscriminatorValue(IParseNode parseNode)
        {
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"permissions", n => { Permissions = n.GetObjectValue<Collaborator_permissions>(Collaborator_permissions.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<Collaborator_permissions>("permissions", Permissions);
