...
namespace GitHub.Models {
    ...
    public class RepositoryRuleMergeQueue_parameters : IAdditionalDataHolder, IParsable 
    #pragma warning restore CS1591
    {
        ...
        public RepositoryRuleMergeQueue_parameters_grouping_strategy? GroupingStrategy { get; set; }
        ...
        public RepositoryRuleMergeQueue_parameters_merge_method? MergeMethod { get; set; }
        ...
        /// <summary>
        /// Instantiates a new <see cref="RepositoryRuleMergeQueue_parameters"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="RepositoryRuleMergeQueue_parameters"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static RepositoryRuleMergeQueue_parameters CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new RepositoryRuleMergeQueue_parameters();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"grouping_strategy", n => { GroupingStrategy = n.GetEnumValue<RepositoryRuleMergeQueue_parameters_grouping_strategy>(); } },
                {"max_entries_to_build", n => { MaxEntriesToBuild = n.GetIntValue(); } },
                {"max_entries_to_merge", n => { MaxEntriesToMerge = n.GetIntValue(); } },
                {"merge_method", n => { MergeMethod = n.GetEnumValue<RepositoryRuleMergeQueue_parameters_merge_method>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<RepositoryRuleMergeQueue_parameters_grouping_strategy>("grouping_strategy", GroupingStrategy);
            writer.WriteIntValue("max_entries_to_build", MaxEntriesToBuild);
            writer.WriteIntValue("max_entries_to_merge", MaxEntriesToMerge);
            writer.WriteEnumValue<RepositoryRuleMergeQueue_parameters_merge_method>("merge_method", MergeMethod);
