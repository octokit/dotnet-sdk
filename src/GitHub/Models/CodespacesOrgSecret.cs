...
namespace GitHub.Models {
    ...
    /// </summary>
    public class CodespacesOrgSecret : IAdditionalDataHolder, IParsable 
    {
...
#nullable restore
        ...
        public CodespacesOrgSecret_visibility? Visibility { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="CodespacesOrgSecret"/> and sets the default values.
        /// </summary>
        ...
        public static CodespacesOrgSecret CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new CodespacesOrgSecret();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"visibility", n => { Visibility = n.GetEnumValue<CodespacesOrgSecret_visibility>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<CodespacesOrgSecret_visibility>("visibility", Visibility);
