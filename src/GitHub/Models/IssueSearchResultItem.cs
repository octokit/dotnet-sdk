...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<IssueSearchResultItem_labels>? Labels { get; set; }
#nullable restore
#else
        public List<IssueSearchResultItem_labels> Labels { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public IssueSearchResultItem_pull_request? PullRequest { get; set; }
#nullable restore
#else
        public IssueSearchResultItem_pull_request PullRequest { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public GitHub.Models.Repository? Repository { get; set; }
#nullable restore
#else
        public GitHub.Models.Repository Repository { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<Issues>? TextMatches { get; set; }
#nullable restore
#else
        public List<Issues> TextMatches { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new issueSearchResultItem and sets the default values.
        /// </summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"labels", n => { Labels = n.GetCollectionOfObjectValues<IssueSearchResultItem_labels>(IssueSearchResultItem_labels.CreateFromDiscriminatorValue)?.ToList(); } },
                ...
                {"text_matches", n => { TextMatches = n.GetCollectionOfObjectValues<Issues>(Issues.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<IssueSearchResultItem_labels>("labels", Labels);
            ...
            writer.WriteObjectValue<GitHub.Models.Repository>("repository", Repository);
            writer.WriteStringValue("repository_url", RepositoryUrl);
            writer.WriteDoubleValue("score", Score);
            writer.WriteStringValue("state", State);
            writer.WriteStringValue("state_reason", StateReason);
            writer.WriteCollectionOfObjectValues<Issues>("text_matches", TextMatches);
