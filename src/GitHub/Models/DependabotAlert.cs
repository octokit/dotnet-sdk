...
#nullable enable
        public global::GitHub.Models.DependabotAlert_dependency? Dependency { get; private set; }
#nullable restore
#else
        public global::GitHub.Models.DependabotAlert_dependency Dependency { get; private set; }
#endif
...
#nullable restore
        ...
        public global::GitHub.Models.DependabotAlert_dismissed_reason? DismissedReason { get; set; }
...
#nullable restore
        ...
        public global::GitHub.Models.DependabotAlert_state? State { get; private set; }
...
#nullable restore
        ...
        public static global::GitHub.Models.DependabotAlert CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::GitHub.Models.DependabotAlert();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "dependency", n => { Dependency = n.GetObjectValue<global::GitHub.Models.DependabotAlert_dependency>(global::GitHub.Models.DependabotAlert_dependency.CreateFromDiscriminatorValue); } },
                ...
                { "dismissed_reason", n => { DismissedReason = n.GetEnumValue<global::GitHub.Models.DependabotAlert_dismissed_reason>(); } },
                ...
                { "state", n => { State = n.GetEnumValue<global::GitHub.Models.DependabotAlert_state>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::GitHub.Models.DependabotAlert_dismissed_reason>("dismissed_reason", DismissedReason);
        }
    }
}
