...
#nullable enable
        public List<CopilotUsageMetrics_breakdown>? Breakdown { get; set; }
#nullable restore
#else
        public List<CopilotUsageMetrics_breakdown> Breakdown { get; set; }
#endif
        ...
        /// </summary>
        /// <returns>A <see cref="CopilotUsageMetrics"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static CopilotUsageMetrics CreateFromDiscriminatorValue(IParseNode parseNode)
        {
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<CopilotUsageMetrics_breakdown>("breakdown", Breakdown);
