...
namespace GitHub.Models {
    ...
    public class OrganizationFull_plan : IAdditionalDataHolder, IParsable 
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="OrganizationFull_plan"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="OrganizationFull_plan"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static OrganizationFull_plan CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new OrganizationFull_plan();
        }
        /// <summary>
