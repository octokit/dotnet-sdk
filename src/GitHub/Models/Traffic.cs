...
namespace GitHub.Models {
    ...
    #pragma warning restore CS1591
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="Traffic"/> and sets the default values.
        /// </summary>
        public Traffic()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="Traffic"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static Traffic CreateFromDiscriminatorValue(IParseNode parseNode)
        {
