...
namespace GitHub.Models {
    ...
    /// </summary>
    public class UnlabeledIssueEvent : IAdditionalDataHolder, IParsable 
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public UnlabeledIssueEvent_label? Label { get; set; }
#nullable restore
#else
        public UnlabeledIssueEvent_label Label { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="UnlabeledIssueEvent"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="UnlabeledIssueEvent"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static UnlabeledIssueEvent CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new UnlabeledIssueEvent();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"label", n => { Label = n.GetObjectValue<UnlabeledIssueEvent_label>(UnlabeledIssueEvent_label.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<UnlabeledIssueEvent_label>("label", Label);
