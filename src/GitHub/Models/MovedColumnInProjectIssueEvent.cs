...
namespace GitHub.Models {
    ...
    /// </summary>
    public class MovedColumnInProjectIssueEvent : IAdditionalDataHolder, IParsable 
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public MovedColumnInProjectIssueEvent_project_card? ProjectCard { get; set; }
#nullable restore
#else
        public MovedColumnInProjectIssueEvent_project_card ProjectCard { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="MovedColumnInProjectIssueEvent"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="MovedColumnInProjectIssueEvent"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static MovedColumnInProjectIssueEvent CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new MovedColumnInProjectIssueEvent();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"project_card", n => { ProjectCard = n.GetObjectValue<MovedColumnInProjectIssueEvent_project_card>(MovedColumnInProjectIssueEvent_project_card.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<MovedColumnInProjectIssueEvent_project_card>("project_card", ProjectCard);
