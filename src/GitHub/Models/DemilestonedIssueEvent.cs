...
namespace GitHub.Models {
    ...
    /// </summary>
    public class DemilestonedIssueEvent : IAdditionalDataHolder, IParsable 
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public DemilestonedIssueEvent_milestone? Milestone { get; set; }
#nullable restore
#else
        public DemilestonedIssueEvent_milestone Milestone { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="DemilestonedIssueEvent"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="DemilestonedIssueEvent"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static DemilestonedIssueEvent CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new DemilestonedIssueEvent();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"milestone", n => { Milestone = n.GetObjectValue<DemilestonedIssueEvent_milestone>(DemilestonedIssueEvent_milestone.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<DemilestonedIssueEvent_milestone>("milestone", Milestone);
