...
namespace GitHub.Models {
    ...
    /// </summary>
    public class Issue : IAdditionalDataHolder, IParsable 
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Issue_pull_request? PullRequest { get; set; }
#nullable restore
#else
        public Issue_pull_request PullRequest { get; set; }
#endif
...
#nullable restore
        ...
        public Issue_state_reason? StateReason { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="Issue"/> and sets the default values.
        /// </summary>
        public Issue()
        {
        ...
        public static Issue CreateFromDiscriminatorValue(IParseNode parseNode)
        {
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"pull_request", n => { PullRequest = n.GetObjectValue<Issue_pull_request>(Issue_pull_request.CreateFromDiscriminatorValue); } },
                ...
                {"state_reason", n => { StateReason = n.GetEnumValue<Issue_state_reason>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<Issue_pull_request>("pull_request", PullRequest);
            ...
            writer.WriteEnumValue<Issue_state_reason>("state_reason", StateReason);
