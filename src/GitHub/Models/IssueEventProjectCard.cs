...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="IssueEventProjectCard"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="IssueEventProjectCard"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static IssueEventProjectCard CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new IssueEventProjectCard();
        }
        /// <summary>
