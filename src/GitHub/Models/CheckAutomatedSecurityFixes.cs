...
namespace GitHub.Models {
    ...
    public class CheckAutomatedSecurityFixes : IAdditionalDataHolder, IParsable 
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="CheckAutomatedSecurityFixes"/> and sets the default values.
        /// </summary>
        ...
        public static CheckAutomatedSecurityFixes CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new CheckAutomatedSecurityFixes();
        }
        /// <summary>
