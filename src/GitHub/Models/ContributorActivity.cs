...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<ContributorActivity_weeks>? Weeks { get; set; }
#nullable restore
#else
        public List<ContributorActivity_weeks> Weeks { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="ContributorActivity"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ContributorActivity"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ContributorActivity CreateFromDiscriminatorValue(IParseNode parseNode)
        {
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<ContributorActivity_weeks>("weeks", Weeks);
