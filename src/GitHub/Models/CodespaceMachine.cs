...
#nullable restore
        ...
        public CodespaceMachine_prebuild_availability? PrebuildAvailability { get; set; }
        /// <summary>How much storage is available to the codespace.</summary>
        public int? StorageInBytes { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="CodespaceMachine"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="CodespaceMachine"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static CodespaceMachine CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new CodespaceMachine();
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<CodespaceMachine_prebuild_availability>("prebuild_availability", PrebuildAvailability);
