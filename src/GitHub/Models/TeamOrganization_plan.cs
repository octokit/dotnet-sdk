...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="TeamOrganization_plan"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="TeamOrganization_plan"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static TeamOrganization_plan CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new TeamOrganization_plan();
        }
        /// <summary>
