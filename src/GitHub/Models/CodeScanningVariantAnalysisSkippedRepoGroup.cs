...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="CodeScanningVariantAnalysisSkippedRepoGroup"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="CodeScanningVariantAnalysisSkippedRepoGroup"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static CodeScanningVariantAnalysisSkippedRepoGroup CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new CodeScanningVariantAnalysisSkippedRepoGroup();
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<CodeScanningVariantAnalysisRepository>("repositories", Repositories);
