...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="OrgRepoCustomPropertyValues"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="OrgRepoCustomPropertyValues"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static OrgRepoCustomPropertyValues CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new OrgRepoCustomPropertyValues();
        }
        /// <summary>
