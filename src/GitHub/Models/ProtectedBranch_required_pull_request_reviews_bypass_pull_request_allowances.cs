...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ProtectedBranch_required_pull_request_reviews_bypass_pull_request_allowances"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ProtectedBranch_required_pull_request_reviews_bypass_pull_request_allowances"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ProtectedBranch_required_pull_request_reviews_bypass_pull_request_allowances CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ProtectedBranch_required_pull_request_reviews_bypass_pull_request_allowances();
        }
        /// <summary>
