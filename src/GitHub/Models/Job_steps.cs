...
#nullable restore
        ...
        public Job_steps_status? Status { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="Job_steps"/> and sets the default values.
        /// </summary>
        public Job_steps()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="Job_steps"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static Job_steps CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Job_steps();
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<Job_steps_status>("status", Status);
