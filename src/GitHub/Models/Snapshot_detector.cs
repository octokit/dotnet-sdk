...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="Snapshot_detector"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static Snapshot_detector CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Snapshot_detector();
        }
        /// <summary>
