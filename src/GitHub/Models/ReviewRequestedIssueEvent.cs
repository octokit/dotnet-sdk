...
namespace GitHub.Models {
    ...
    /// </summary>
    public class ReviewRequestedIssueEvent : IAdditionalDataHolder, IParsable 
    {
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ReviewRequestedIssueEvent"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ReviewRequestedIssueEvent"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ReviewRequestedIssueEvent CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ReviewRequestedIssueEvent();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"requested_reviewer", n => { RequestedReviewer = n.GetObjectValue<SimpleUser>(SimpleUser.CreateFromDiscriminatorValue); } },
                {"requested_team", n => { RequestedTeam = n.GetObjectValue<Team>(Team.CreateFromDiscriminatorValue); } },
                {"review_requester", n => { ReviewRequester = n.GetObjectValue<SimpleUser>(SimpleUser.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<SimpleUser>("requested_reviewer", RequestedReviewer);
            writer.WriteObjectValue<Team>("requested_team", RequestedTeam);
            writer.WriteObjectValue<SimpleUser>("review_requester", ReviewRequester);
