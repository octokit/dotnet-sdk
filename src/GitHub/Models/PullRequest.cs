...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::GitHub.Models.PullRequest_base? Base { get; set; }
#nullable restore
#else
        public global::GitHub.Models.PullRequest_base Base { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::GitHub.Models.PullRequest_head? Head { get; set; }
#nullable restore
#else
        public global::GitHub.Models.PullRequest_head Head { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::GitHub.Models.PullRequest_labels>? Labels { get; set; }
#nullable restore
#else
        public List<global::GitHub.Models.PullRequest_labels> Labels { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::GitHub.Models.PullRequest__links? Links { get; set; }
#nullable restore
#else
        public global::GitHub.Models.PullRequest__links Links { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::GitHub.Models.NullableSimpleUser? MergedBy { get; set; }
#nullable restore
#else
        public global::GitHub.Models.NullableSimpleUser MergedBy { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::GitHub.Models.TeamSimple>? RequestedTeams { get; set; }
#nullable restore
#else
        public List<global::GitHub.Models.TeamSimple> RequestedTeams { get; set; }
#endif
...
#nullable restore
        ...
        public global::GitHub.Models.PullRequest_state? State { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.Models.PullRequest"/> and sets the default values.
        /// </summary>
        public PullRequest()
        {
        ...
        public static global::GitHub.Models.PullRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::GitHub.Models.PullRequest();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "base", n => { Base = n.GetObjectValue<global::GitHub.Models.PullRequest_base>(global::GitHub.Models.PullRequest_base.CreateFromDiscriminatorValue); } },
                ...
                { "head", n => { Head = n.GetObjectValue<global::GitHub.Models.PullRequest_head>(global::GitHub.Models.PullRequest_head.CreateFromDiscriminatorValue); } },
                { "html_url", n => { HtmlUrl = n.GetStringValue(); } },
                { "id", n => { Id = n.GetLongValue(); } },
                { "issue_url", n => { IssueUrl = n.GetStringValue(); } },
                { "labels", n => { Labels = n.GetCollectionOfObjectValues<global::GitHub.Models.PullRequest_labels>(global::GitHub.Models.PullRequest_labels.CreateFromDiscriminatorValue)?.AsList(); } },
                { "_links", n => { Links = n.GetObjectValue<global::GitHub.Models.PullRequest__links>(global::GitHub.Models.PullRequest__links.CreateFromDiscriminatorValue); } },
                ...
                { "merged_by", n => { MergedBy = n.GetObjectValue<global::GitHub.Models.NullableSimpleUser>(global::GitHub.Models.NullableSimpleUser.CreateFromDiscriminatorValue); } },
                ...
                { "requested_teams", n => { RequestedTeams = n.GetCollectionOfObjectValues<global::GitHub.Models.TeamSimple>(global::GitHub.Models.TeamSimple.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "state", n => { State = n.GetEnumValue<global::GitHub.Models.PullRequest_state>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::GitHub.Models.PullRequest_base>("base", Base);
            ...
            writer.WriteObjectValue<global::GitHub.Models.PullRequest_head>("head", Head);
            writer.WriteStringValue("html_url", HtmlUrl);
            writer.WriteLongValue("id", Id);
            writer.WriteStringValue("issue_url", IssueUrl);
            writer.WriteCollectionOfObjectValues<global::GitHub.Models.PullRequest_labels>("labels", Labels);
            writer.WriteObjectValue<global::GitHub.Models.PullRequest__links>("_links", Links);
            ...
            writer.WriteObjectValue<global::GitHub.Models.NullableSimpleUser>("merged_by", MergedBy);
            ...
            writer.WriteCollectionOfObjectValues<global::GitHub.Models.TeamSimple>("requested_teams", RequestedTeams);
            ...
            writer.WriteEnumValue<global::GitHub.Models.PullRequest_state>("state", State);
