...
namespace GitHub.Models {
    ...
    /// Private User
    /// </summary>
    public class PrivateUser : IAdditionalDataHolder, IParsable 
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public PrivateUser_plan? Plan { get; set; }
#nullable restore
#else
        public PrivateUser_plan Plan { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="PrivateUser"/> and sets the default values.
        /// </summary>
        public PrivateUser()
        {
        ...
        public static PrivateUser CreateFromDiscriminatorValue(IParseNode parseNode)
        {
