...
namespace GitHub.Models
{
    ...
    public partial class SecretScanningScan : IAdditionalDataHolder, IParsable
    {
        ...
        /// <summary>The time that the scan was completed. Empty if the scan is active</summary>
        public DateTimeOffset? CompletedAt { get; set; }
        /// <summary>The time that the scan was started</summary>
        public DateTimeOffset? StartedAt { get; set; }
        /// <summary>The state of the scan. Either &quot;completed&quot; or &quot;running&quot;</summary>
