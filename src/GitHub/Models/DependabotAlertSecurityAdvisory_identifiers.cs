...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="DependabotAlertSecurityAdvisory_identifiers"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static DependabotAlertSecurityAdvisory_identifiers CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new DependabotAlertSecurityAdvisory_identifiers();
        }
        /// <summary>
