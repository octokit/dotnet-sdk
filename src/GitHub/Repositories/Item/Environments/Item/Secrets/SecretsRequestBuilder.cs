// <auto-generated/>
using GitHub.Repositories.Item.Environments.Item.Secrets.Item;
using GitHub.Repositories.Item.Environments.Item.Secrets.PublicKey;
...
using System;
namespace GitHub.Repositories.Item.Environments.Item.Secrets {
    /// <summary>
    ...
    public class SecretsRequestBuilder : BaseRequestBuilder {
        ...
        /// <summary>Gets an item from the GitHub.repositories.item.environments.item.secrets.item collection</summary>
        ...
        public SecretsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repositories/{repository_id}/environments/{environment_name}/secrets{?page*,per_page*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SecretsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SecretsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repositories/{repository_id}/environments/{environment_name}/secrets{?page*,per_page*}", rawUrl) {
        }
        /// <summary>
