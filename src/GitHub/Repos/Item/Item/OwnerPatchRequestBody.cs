...
namespace GitHub.Repos.Item.Item {
    public class OwnerPatchRequestBody : IAdditionalDataHolder, IParsable {
...
#nullable restore
        ...
        public OwnerPatchRequestBody_merge_commit_message? MergeCommitMessage { get; set; }
        ...
        public OwnerPatchRequestBody_merge_commit_title? MergeCommitTitle { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public OwnerPatchRequestBody_security_and_analysis? SecurityAndAnalysis { get; set; }
#nullable restore
#else
        public OwnerPatchRequestBody_security_and_analysis SecurityAndAnalysis { get; set; }
#endif
        ...
        public OwnerPatchRequestBody_squash_merge_commit_message? SquashMergeCommitMessage { get; set; }
        ...
        public OwnerPatchRequestBody_squash_merge_commit_title? SquashMergeCommitTitle { get; set; }
        ...
        public OwnerPatchRequestBody_visibility? Visibility { get; set; }
        ...
        /// <summary>
        /// Instantiates a new <see cref="OwnerPatchRequestBody"/> and sets the default values.
        /// </summary>
        public OwnerPatchRequestBody() {
            AdditionalData = new Dictionary<string, object>();
        }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="OwnerPatchRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static OwnerPatchRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new OwnerPatchRequestBody();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"merge_commit_message", n => { MergeCommitMessage = n.GetEnumValue<OwnerPatchRequestBody_merge_commit_message>(); } },
                {"merge_commit_title", n => { MergeCommitTitle = n.GetEnumValue<OwnerPatchRequestBody_merge_commit_title>(); } },
                {"name", n => { Name = n.GetStringValue(); } },
                {"private", n => { Private = n.GetBoolValue(); } },
                {"security_and_analysis", n => { SecurityAndAnalysis = n.GetObjectValue<OwnerPatchRequestBody_security_and_analysis>(OwnerPatchRequestBody_security_and_analysis.CreateFromDiscriminatorValue); } },
                {"squash_merge_commit_message", n => { SquashMergeCommitMessage = n.GetEnumValue<OwnerPatchRequestBody_squash_merge_commit_message>(); } },
                {"squash_merge_commit_title", n => { SquashMergeCommitTitle = n.GetEnumValue<OwnerPatchRequestBody_squash_merge_commit_title>(); } },
                {"use_squash_pr_title_as_default", n => { UseSquashPrTitleAsDefault = n.GetBoolValue(); } },
                {"visibility", n => { Visibility = n.GetEnumValue<OwnerPatchRequestBody_visibility>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteEnumValue<OwnerPatchRequestBody_merge_commit_message>("merge_commit_message", MergeCommitMessage);
            writer.WriteEnumValue<OwnerPatchRequestBody_merge_commit_title>("merge_commit_title", MergeCommitTitle);
            writer.WriteStringValue("name", Name);
            writer.WriteBoolValue("private", Private);
            writer.WriteObjectValue<OwnerPatchRequestBody_security_and_analysis>("security_and_analysis", SecurityAndAnalysis);
            writer.WriteEnumValue<OwnerPatchRequestBody_squash_merge_commit_message>("squash_merge_commit_message", SquashMergeCommitMessage);
            writer.WriteEnumValue<OwnerPatchRequestBody_squash_merge_commit_title>("squash_merge_commit_title", SquashMergeCommitTitle);
            writer.WriteBoolValue("use_squash_pr_title_as_default", UseSquashPrTitleAsDefault);
            writer.WriteEnumValue<OwnerPatchRequestBody_visibility>("visibility", Visibility);
