...
namespace GitHub.Repos.Item.Item.CodeScanning.Analyses.Item {
    ...
    public class WithAnalysis_ItemRequestBuilder : BaseRequestBuilder {
        ...
        public WithAnalysis_ItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{repos%2Did}/{Owner%2Did}/code-scanning/analyses/{analysis_id}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new <see cref="WithAnalysis_ItemRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithAnalysis_ItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{repos%2Did}/{Owner%2Did}/code-scanning/analyses/{analysis_id}", rawUrl) {
        }
        /// <summary>
...
#nullable restore
        ...
        public RequestInformation ToDeleteRequestInformation(Action<RequestConfiguration<WithAnalysis_ItemRequestBuilderDeleteQueryParameters>> requestConfiguration = default) {
#endif
            var requestInfo = new RequestInformation(Method.DELETE, "{+baseurl}/repos/{repos%2Did}/{Owner%2Did}/code-scanning/analyses/{analysis_id}{?confirm_delete*}", PathParameters);
