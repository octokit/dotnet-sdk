...
namespace GitHub.Repos.Item.Item.Contributors {
    ...
    public class ContributorsRequestBuilder : BaseRequestBuilder {
        ...
        public ContributorsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{repos%2Did}/{Owner%2Did}/contributors{?anon*,page*,per_page*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ContributorsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ContributorsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{repos%2Did}/{Owner%2Did}/contributors{?anon*,page*,per_page*}", rawUrl) {
        }
        /// <summary>
