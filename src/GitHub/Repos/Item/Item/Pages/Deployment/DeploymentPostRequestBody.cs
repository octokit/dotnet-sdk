...
namespace GitHub.Repos.Item.Item.Pages.Deployment {
    ...
    /// </summary>
    public class DeploymentPostRequestBody : IAdditionalDataHolder, IParsable {
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new deploymentPostRequestBody and sets the default values.
        /// </summary>
        public DeploymentPostRequestBody() {
        ...
        public static DeploymentPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new DeploymentPostRequestBody();
        }
        /// <summary>
