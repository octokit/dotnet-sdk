...
namespace GitHub.Repos.Item.Item.Git.Commits {
    ...
    /// </summary>
    public class CommitsPostRequestBody_committer : IAdditionalDataHolder, IParsable 
    {
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="CommitsPostRequestBody_committer"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="CommitsPostRequestBody_committer"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static CommitsPostRequestBody_committer CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new CommitsPostRequestBody_committer();
        }
        /// <summary>
