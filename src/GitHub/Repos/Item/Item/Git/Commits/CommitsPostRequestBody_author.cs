...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="CommitsPostRequestBody_author"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="CommitsPostRequestBody_author"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static CommitsPostRequestBody_author CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new CommitsPostRequestBody_author();
        }
        /// <summary>
