...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public TagsPostRequestBody_tagger? Tagger { get; set; }
#nullable restore
#else
        public TagsPostRequestBody_tagger Tagger { get; set; }
#endif
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"tagger", n => { Tagger = n.GetObjectValue<TagsPostRequestBody_tagger>(TagsPostRequestBody_tagger.CreateFromDiscriminatorValue); } },
                {"type", n => { Type = n.GetEnumValue<TagsPostRequestBody_type>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<TagsPostRequestBody_tagger>("tagger", Tagger);
            writer.WriteEnumValue<TagsPostRequestBody_type>("type", Type);
