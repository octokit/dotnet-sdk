...
namespace GitHub.Repos.Item.Item.Actions.Jobs.Item.Rerun {
    /// <summary>
    /// Builds and executes requests for operations under \repos\{repos-id}\{Owner-id}\actions\jobs\{job_id}\rerun
    /// </summary>
    public class RerunRequestBuilder : BaseRequestBuilder {
        ...
        public RerunRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{repos%2Did}/{Owner%2Did}/actions/jobs/{job_id}/rerun", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new RerunRequestBuilder and sets the default values.
        /// </summary>
