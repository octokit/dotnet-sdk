...
namespace GitHub.Repos.Item.Item.Collaborators {
    ...
    public class CollaboratorsRequestBuilder : BaseRequestBuilder {
        ...
        public CollaboratorsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{repos%2Did}/{Owner%2Did}/collaborators{?affiliation*,page*,per_page*,permission*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new <see cref="CollaboratorsRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CollaboratorsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{repos%2Did}/{Owner%2Did}/collaborators{?affiliation*,page*,per_page*,permission*}", rawUrl) {
        }
        /// <summary>
