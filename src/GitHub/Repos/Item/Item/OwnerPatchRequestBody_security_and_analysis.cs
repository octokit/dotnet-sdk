...
namespace GitHub.Repos.Item.Item {
    ...
    /// </summary>
    public class OwnerPatchRequestBody_security_and_analysis : IAdditionalDataHolder, IParsable {
...
#nullable enable
        public OwnerPatchRequestBody_security_and_analysis_advanced_security? AdvancedSecurity { get; set; }
#nullable restore
#else
        public OwnerPatchRequestBody_security_and_analysis_advanced_security AdvancedSecurity { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public OwnerPatchRequestBody_security_and_analysis_secret_scanning? SecretScanning { get; set; }
#nullable restore
#else
        public OwnerPatchRequestBody_security_and_analysis_secret_scanning SecretScanning { get; set; }
#endif
...
#nullable restore
        ...
        public static OwnerPatchRequestBody_security_and_analysis CreateFromDiscriminatorValue(IParseNode parseNode) {
            ...
            return new OwnerPatchRequestBody_security_and_analysis();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"secret_scanning", n => { SecretScanning = n.GetObjectValue<OwnerPatchRequestBody_security_and_analysis_secret_scanning>(OwnerPatchRequestBody_security_and_analysis_secret_scanning.CreateFromDiscriminatorValue); } },
                {"secret_scanning_push_protection", n => { SecretScanningPushProtection = n.GetObjectValue<OwnerPatchRequestBody_security_and_analysis_secret_scanning_push_protection>(OwnerPatchRequestBody_security_and_analysis_secret_scanning_push_protection.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<OwnerPatchRequestBody_security_and_analysis_advanced_security>("advanced_security", AdvancedSecurity);
            writer.WriteObjectValue<OwnerPatchRequestBody_security_and_analysis_secret_scanning>("secret_scanning", SecretScanning);
            writer.WriteObjectValue<OwnerPatchRequestBody_security_and_analysis_secret_scanning_push_protection>("secret_scanning_push_protection", SecretScanningPushProtection);
