...
namespace GitHub.Octokit.Models {
    public class NullableRepository_template_repository : IAdditionalDataHolder, IParsable {
...
#nullable restore
        ...
        public NullableRepository_template_repository_merge_commit_message? MergeCommitMessage { get; set; }
        ...
        public NullableRepository_template_repository_merge_commit_title? MergeCommitTitle { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public NullableRepository_template_repository_owner? Owner { get; set; }
#nullable restore
#else
        public NullableRepository_template_repository_owner Owner { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public NullableRepository_template_repository_permissions? Permissions { get; set; }
#nullable restore
#else
        public NullableRepository_template_repository_permissions Permissions { get; set; }
#endif
...
#nullable restore
        ...
        public NullableRepository_template_repository_squash_merge_commit_message? SquashMergeCommitMessage { get; set; }
        ...
        public NullableRepository_template_repository_squash_merge_commit_title? SquashMergeCommitTitle { get; set; }
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new nullableRepository_template_repository and sets the default values.
        /// </summary>
        public NullableRepository_template_repository() {
        ...
        public static NullableRepository_template_repository CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new NullableRepository_template_repository();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"merge_commit_message", n => { MergeCommitMessage = n.GetEnumValue<NullableRepository_template_repository_merge_commit_message>(); } },
                {"merge_commit_title", n => { MergeCommitTitle = n.GetEnumValue<NullableRepository_template_repository_merge_commit_title>(); } },
                ...
                {"owner", n => { Owner = n.GetObjectValue<NullableRepository_template_repository_owner>(NullableRepository_template_repository_owner.CreateFromDiscriminatorValue); } },
                {"permissions", n => { Permissions = n.GetObjectValue<NullableRepository_template_repository_permissions>(NullableRepository_template_repository_permissions.CreateFromDiscriminatorValue); } },
                ...
                {"squash_merge_commit_message", n => { SquashMergeCommitMessage = n.GetEnumValue<NullableRepository_template_repository_squash_merge_commit_message>(); } },
                {"squash_merge_commit_title", n => { SquashMergeCommitTitle = n.GetEnumValue<NullableRepository_template_repository_squash_merge_commit_title>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteEnumValue<NullableRepository_template_repository_merge_commit_message>("merge_commit_message", MergeCommitMessage);
            writer.WriteEnumValue<NullableRepository_template_repository_merge_commit_title>("merge_commit_title", MergeCommitTitle);
            ...
            writer.WriteObjectValue<NullableRepository_template_repository_owner>("owner", Owner);
            writer.WriteObjectValue<NullableRepository_template_repository_permissions>("permissions", Permissions);
            ...
            writer.WriteEnumValue<NullableRepository_template_repository_squash_merge_commit_message>("squash_merge_commit_message", SquashMergeCommitMessage);
            writer.WriteEnumValue<NullableRepository_template_repository_squash_merge_commit_title>("squash_merge_commit_title", SquashMergeCommitTitle);
