...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public GistSimple_files? Files { get; set; }
#nullable restore
#else
        public GistSimple_files Files { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public GistSimple_fork_of? ForkOf { get; set; }
#nullable restore
#else
        public GistSimple_fork_of ForkOf { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<GistSimple_forks>? Forks { get; set; }
#nullable restore
#else
        public List<GistSimple_forks> Forks { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new gistSimple and sets the default values.
        /// </summary>
        public GistSimple() {
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<GistSimple_files>("files", Files);
            writer.WriteObjectValue<GistSimple_fork_of>("fork_of", ForkOf);
            writer.WriteCollectionOfObjectValues<GistSimple_forks>("forks", Forks);
            ...
            writer.WriteCollectionOfObjectValues<GistHistory>("history", History);
