...
#nullable restore
        ...
        public NullableRepository_merge_commit_message? MergeCommitMessage { get; set; }
        ...
        public NullableRepository_merge_commit_title? MergeCommitTitle { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public NullableRepository_permissions? Permissions { get; set; }
#nullable restore
#else
        public NullableRepository_permissions Permissions { get; set; }
#endif
...
#nullable restore
        ...
        public NullableRepository_squash_merge_commit_message? SquashMergeCommitMessage { get; set; }
        ...
        public NullableRepository_squash_merge_commit_title? SquashMergeCommitTitle { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public NullableRepository_template_repository? TemplateRepository { get; set; }
#nullable restore
#else
        public NullableRepository_template_repository TemplateRepository { get; set; }
#endif
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new nullableRepository and sets the default values.
        /// </summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"merge_commit_message", n => { MergeCommitMessage = n.GetEnumValue<NullableRepository_merge_commit_message>(); } },
                {"merge_commit_title", n => { MergeCommitTitle = n.GetEnumValue<NullableRepository_merge_commit_title>(); } },
                ...
                {"permissions", n => { Permissions = n.GetObjectValue<NullableRepository_permissions>(NullableRepository_permissions.CreateFromDiscriminatorValue); } },
                ...
                {"squash_merge_commit_message", n => { SquashMergeCommitMessage = n.GetEnumValue<NullableRepository_squash_merge_commit_message>(); } },
                {"squash_merge_commit_title", n => { SquashMergeCommitTitle = n.GetEnumValue<NullableRepository_squash_merge_commit_title>(); } },
                ...
                {"template_repository", n => { TemplateRepository = n.GetObjectValue<NullableRepository_template_repository>(NullableRepository_template_repository.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteEnumValue<NullableRepository_merge_commit_message>("merge_commit_message", MergeCommitMessage);
            writer.WriteEnumValue<NullableRepository_merge_commit_title>("merge_commit_title", MergeCommitTitle);
            ...
            writer.WriteObjectValue<NullableRepository_permissions>("permissions", Permissions);
            ...
            writer.WriteEnumValue<NullableRepository_squash_merge_commit_message>("squash_merge_commit_message", SquashMergeCommitMessage);
            writer.WriteEnumValue<NullableRepository_squash_merge_commit_title>("squash_merge_commit_title", SquashMergeCommitTitle);
            ...
            writer.WriteObjectValue<NullableRepository_template_repository>("template_repository", TemplateRepository);
