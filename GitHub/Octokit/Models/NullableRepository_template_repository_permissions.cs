...
namespace GitHub.Octokit.Models {
    public class NullableRepository_template_repository_permissions : IAdditionalDataHolder, IParsable {
        ...
        /// <summary>
        /// Instantiates a new nullableRepository_template_repository_permissions and sets the default values.
        /// </summary>
        public NullableRepository_template_repository_permissions() {
        ...
        public static NullableRepository_template_repository_permissions CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new NullableRepository_template_repository_permissions();
        }
        /// <summary>
