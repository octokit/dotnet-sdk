...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public OrganizationProgrammaticAccessGrantRequest_permissions? Permissions { get; set; }
#nullable restore
#else
        public OrganizationProgrammaticAccessGrantRequest_permissions Permissions { get; set; }
#endif
...
#nullable restore
        ...
        public OrganizationProgrammaticAccessGrantRequest_repository_selection? RepositorySelection { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new organizationProgrammaticAccessGrantRequest and sets the default values.
        /// </summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"permissions", n => { Permissions = n.GetObjectValue<OrganizationProgrammaticAccessGrantRequest_permissions>(OrganizationProgrammaticAccessGrantRequest_permissions.CreateFromDiscriminatorValue); } },
                {"reason", n => { Reason = n.GetStringValue(); } },
                {"repositories_url", n => { RepositoriesUrl = n.GetStringValue(); } },
                {"repository_selection", n => { RepositorySelection = n.GetEnumValue<OrganizationProgrammaticAccessGrantRequest_repository_selection>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<OrganizationProgrammaticAccessGrantRequest_permissions>("permissions", Permissions);
            writer.WriteStringValue("reason", Reason);
            writer.WriteStringValue("repositories_url", RepositoriesUrl);
            writer.WriteEnumValue<OrganizationProgrammaticAccessGrantRequest_repository_selection>("repository_selection", RepositorySelection);
