...
#nullable enable
        public async Task<Octokit.Client.Models.Hovercard?> GetAsync(Action<RequestConfiguration<HovercardRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Octokit.Client.Models.Hovercard> GetAsync(Action<RequestConfiguration<HovercardRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
