...
using Octokit.Client.Users.Item.Following.Item;
...
using System;
namespace Octokit.Client.Users.Item.Following {
    /// <summary>
    ...
    public class FollowingRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.users.item.following.item collection</summary>
