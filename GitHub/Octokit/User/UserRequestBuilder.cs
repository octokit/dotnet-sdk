...
using Octokit.Client.User.Blocks;
using Octokit.Client.User.Codespaces;
using Octokit.Client.User.Docker;
using Octokit.Client.User.Email;
using Octokit.Client.User.Emails;
using Octokit.Client.User.Followers;
using Octokit.Client.User.Following;
using Octokit.Client.User.Gpg_keys;
using Octokit.Client.User.Installations;
using Octokit.Client.User.InteractionLimits;
using Octokit.Client.User.Issues;
using Octokit.Client.User.Keys;
using Octokit.Client.User.Marketplace_purchases;
using Octokit.Client.User.Memberships;
using Octokit.Client.User.Migrations;
using Octokit.Client.User.Orgs;
using Octokit.Client.User.Packages;
using Octokit.Client.User.Projects;
using Octokit.Client.User.Public_emails;
using Octokit.Client.User.Repos;
using Octokit.Client.User.Repository_invitations;
using Octokit.Client.User.Social_accounts;
using Octokit.Client.User.Ssh_signing_keys;
using Octokit.Client.User.Starred;
using Octokit.Client.User.Subscriptions;
using Octokit.Client.User.Teams;
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
            public Octokit.Client.Models.PrivateUser? PrivateUser { get; set; }
#nullable restore
#else
            public Octokit.Client.Models.PrivateUser PrivateUser { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
            public Octokit.Client.Models.PublicUser? PublicUser { get; set; }
#nullable restore
#else
            public Octokit.Client.Models.PublicUser PublicUser { get; set; }
#endif
            ...
            public static UserGetResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
                ...
                if("private-user".Equals(mappingValue, StringComparison.OrdinalIgnoreCase)) {
                    result.PrivateUser = new Octokit.Client.Models.PrivateUser();
                }
                else if("public-user".Equals(mappingValue, StringComparison.OrdinalIgnoreCase)) {
                    result.PublicUser = new Octokit.Client.Models.PublicUser();
                }
                return result;
            }
            /// <summary>
            ...
            public virtual void Serialize(ISerializationWriter writer) {
                ...
                if(PrivateUser != null) {
                    writer.WriteObjectValue<Octokit.Client.Models.PrivateUser>(null, PrivateUser);
                }
                else if(PublicUser != null) {
                    writer.WriteObjectValue<Octokit.Client.Models.PublicUser>(null, PublicUser);
                }
            }
        }
        /// <summary>
