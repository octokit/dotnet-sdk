...
using System;
namespace Octokit.Client.User.Email.Visibility {
    /// <summary>
...
#nullable enable
        public async Task<List<Octokit.Client.Models.Email>?> PatchAsync(VisibilityPatchRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<List<Octokit.Client.Models.Email>> PatchAsync(VisibilityPatchRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
