...
using System;
namespace Octokit.Client.User.Emails {
    /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<List<GitHub.Octokit.Models.Email>?> GetAsync(Action<RequestConfiguration<EmailsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<List<GitHub.Octokit.Models.Email>> GetAsync(Action<RequestConfiguration<EmailsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<List<GitHub.Octokit.Models.Email>?> PostAsync(EmailsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<List<GitHub.Octokit.Models.Email>> PostAsync(EmailsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
            public Octokit.Client.User.Emails.EmailsDeleteRequestBodyMember1? EmailsDeleteRequestBodyEmailsDeleteRequestBodyMember1 { get; set; }
#nullable restore
#else
            public Octokit.Client.User.Emails.EmailsDeleteRequestBodyMember1 EmailsDeleteRequestBodyEmailsDeleteRequestBodyMember1 { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
            public Octokit.Client.User.Emails.EmailsDeleteRequestBodyMember1? EmailsDeleteRequestBodyMember1 { get; set; }
#nullable restore
#else
            public Octokit.Client.User.Emails.EmailsDeleteRequestBodyMember1 EmailsDeleteRequestBodyMember1 { get; set; }
#endif
...
#nullable restore
            ...
            public static EmailsDeleteRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
                ...
                if("".Equals(mappingValue, StringComparison.OrdinalIgnoreCase)) {
                    result.EmailsDeleteRequestBodyEmailsDeleteRequestBodyMember1 = new Octokit.Client.User.Emails.EmailsDeleteRequestBodyMember1();
                }
                else if("".Equals(mappingValue, StringComparison.OrdinalIgnoreCase)) {
                    result.EmailsDeleteRequestBodyMember1 = new Octokit.Client.User.Emails.EmailsDeleteRequestBodyMember1();
                }
            ...
            public virtual void Serialize(ISerializationWriter writer) {
                ...
                if(EmailsDeleteRequestBodyEmailsDeleteRequestBodyMember1 != null) {
                    writer.WriteObjectValue<Octokit.Client.User.Emails.EmailsDeleteRequestBodyMember1>(null, EmailsDeleteRequestBodyEmailsDeleteRequestBodyMember1);
                }
                else if(EmailsDeleteRequestBodyMember1 != null) {
                    writer.WriteObjectValue<Octokit.Client.User.Emails.EmailsDeleteRequestBodyMember1>(null, EmailsDeleteRequestBodyMember1);
                }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
            public Octokit.Client.User.Emails.EmailsPostRequestBodyMember1? EmailsPostRequestBodyEmailsPostRequestBodyMember1 { get; set; }
#nullable restore
#else
            public Octokit.Client.User.Emails.EmailsPostRequestBodyMember1 EmailsPostRequestBodyEmailsPostRequestBodyMember1 { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
            public Octokit.Client.User.Emails.EmailsPostRequestBodyMember1? EmailsPostRequestBodyMember1 { get; set; }
#nullable restore
#else
            public Octokit.Client.User.Emails.EmailsPostRequestBodyMember1 EmailsPostRequestBodyMember1 { get; set; }
#endif
...
#nullable restore
            ...
            public static EmailsPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
                ...
                if("".Equals(mappingValue, StringComparison.OrdinalIgnoreCase)) {
                    result.EmailsPostRequestBodyEmailsPostRequestBodyMember1 = new Octokit.Client.User.Emails.EmailsPostRequestBodyMember1();
                }
                else if("".Equals(mappingValue, StringComparison.OrdinalIgnoreCase)) {
                    result.EmailsPostRequestBodyMember1 = new Octokit.Client.User.Emails.EmailsPostRequestBodyMember1();
                }
            ...
            public virtual void Serialize(ISerializationWriter writer) {
                _ = writer ?? throw new ArgumentNullException(nameof(writer));
                if(EmailsPostRequestBodyEmailsPostRequestBodyMember1 != null) {
                    writer.WriteObjectValue<Octokit.Client.User.Emails.EmailsPostRequestBodyMember1>(null, EmailsPostRequestBodyEmailsPostRequestBodyMember1);
                }
                else if(EmailsPostRequestBodyMember1 != null) {
                    writer.WriteObjectValue<Octokit.Client.User.Emails.EmailsPostRequestBodyMember1>(null, EmailsPostRequestBodyMember1);
                }
        ...
        public class EmailsRequestBuilderDeleteRequestConfiguration : RequestConfiguration<DefaultQueryParameters> {
        }
        /// <summary>
        /// Lists all of your email addresses, and specifies which one is visible to the public. This endpoint is accessible with the `user:email` scope.
        /// </summary>
        ...
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class EmailsRequestBuilderGetRequestConfiguration : RequestConfiguration<EmailsRequestBuilderGetQueryParameters> {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
        /// </summary>
