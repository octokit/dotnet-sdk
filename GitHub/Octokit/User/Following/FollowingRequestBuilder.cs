...
using Octokit.Client.User.Following.Item;
...
using System;
namespace Octokit.Client.User.Following {
    /// <summary>
    /// Builds and executes requests for operations under \user\following
    /// </summary>
    public class FollowingRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.user.following.item collection</summary>
