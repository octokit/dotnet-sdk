...
using System.Linq;
using System;
namespace Octokit.Client.User.Memberships.Orgs.Item {
    public class WithOrgPatchRequestBody : IAdditionalDataHolder, IParsable {
        ...
        public WithOrgPatchRequestBody_state? State { get; set; }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteEnumValue<WithOrgPatchRequestBody_state>("state", State);
