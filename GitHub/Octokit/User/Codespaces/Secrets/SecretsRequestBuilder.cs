...
using Octokit.Client.User.Codespaces.Secrets.Item;
using Octokit.Client.User.Codespaces.Secrets.PublicKey;
...
namespace Octokit.Client.User.Codespaces.Secrets {
    ...
    public class SecretsRequestBuilder : BaseRequestBuilder {
        ...
        /// <summary>Gets an item from the Octokit.Client.user.codespaces.secrets.item collection</summary>
