...
using Octokit.Client.User.Codespaces.Item.Exports.Item;
...
using System;
namespace Octokit.Client.User.Codespaces.Item.Exports {
    /// <summary>
    ...
    public class ExportsRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.user.codespaces.item.exports.item collection</summary>
