...
using Octokit.Client.User.Codespaces.Item;
using Octokit.Client.User.Codespaces.Secrets;
...
namespace Octokit.Client.User.Codespaces {
    ...
    public class CodespacesRequestBuilder : BaseRequestBuilder {
        ...
        /// <summary>Gets an item from the Octokit.Client.user.codespaces.item collection</summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
            public Octokit.Client.User.Codespaces.CodespacesPostRequestBodyMember1? CodespacesPostRequestBodyCodespacesPostRequestBodyMember1 { get; set; }
#nullable restore
#else
            public Octokit.Client.User.Codespaces.CodespacesPostRequestBodyMember1 CodespacesPostRequestBodyCodespacesPostRequestBodyMember1 { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
            public Octokit.Client.User.Codespaces.CodespacesPostRequestBodyMember2? CodespacesPostRequestBodyCodespacesPostRequestBodyMember2 { get; set; }
#nullable restore
#else
            public Octokit.Client.User.Codespaces.CodespacesPostRequestBodyMember2 CodespacesPostRequestBodyCodespacesPostRequestBodyMember2 { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
            public Octokit.Client.User.Codespaces.CodespacesPostRequestBodyMember1? CodespacesPostRequestBodyMember1 { get; set; }
#nullable restore
#else
            public Octokit.Client.User.Codespaces.CodespacesPostRequestBodyMember1 CodespacesPostRequestBodyMember1 { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
            public Octokit.Client.User.Codespaces.CodespacesPostRequestBodyMember2? CodespacesPostRequestBodyMember2 { get; set; }
#nullable restore
#else
            public Octokit.Client.User.Codespaces.CodespacesPostRequestBodyMember2 CodespacesPostRequestBodyMember2 { get; set; }
#endif
            ...
            public static CodespacesPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
                ...
                if("".Equals(mappingValue, StringComparison.OrdinalIgnoreCase)) {
                    result.CodespacesPostRequestBodyCodespacesPostRequestBodyMember1 = new Octokit.Client.User.Codespaces.CodespacesPostRequestBodyMember1();
                }
                else if("".Equals(mappingValue, StringComparison.OrdinalIgnoreCase)) {
                    result.CodespacesPostRequestBodyCodespacesPostRequestBodyMember2 = new Octokit.Client.User.Codespaces.CodespacesPostRequestBodyMember2();
                }
                else if("".Equals(mappingValue, StringComparison.OrdinalIgnoreCase)) {
                    result.CodespacesPostRequestBodyMember1 = new Octokit.Client.User.Codespaces.CodespacesPostRequestBodyMember1();
                }
                else if("".Equals(mappingValue, StringComparison.OrdinalIgnoreCase)) {
                    result.CodespacesPostRequestBodyMember2 = new Octokit.Client.User.Codespaces.CodespacesPostRequestBodyMember2();
                }
                return result;
            }
            /// <summary>
            ...
            public virtual void Serialize(ISerializationWriter writer) {
                ...
                if(CodespacesPostRequestBodyCodespacesPostRequestBodyMember1 != null) {
                    writer.WriteObjectValue<Octokit.Client.User.Codespaces.CodespacesPostRequestBodyMember1>(null, CodespacesPostRequestBodyCodespacesPostRequestBodyMember1);
                }
                else if(CodespacesPostRequestBodyCodespacesPostRequestBodyMember2 != null) {
                    writer.WriteObjectValue<Octokit.Client.User.Codespaces.CodespacesPostRequestBodyMember2>(null, CodespacesPostRequestBodyCodespacesPostRequestBodyMember2);
                }
                else if(CodespacesPostRequestBodyMember1 != null) {
                    writer.WriteObjectValue<Octokit.Client.User.Codespaces.CodespacesPostRequestBodyMember1>(null, CodespacesPostRequestBodyMember1);
                }
                else if(CodespacesPostRequestBodyMember2 != null) {
                    writer.WriteObjectValue<Octokit.Client.User.Codespaces.CodespacesPostRequestBodyMember2>(null, CodespacesPostRequestBodyMember2);
                }
            }
        }
        /// <summary>
