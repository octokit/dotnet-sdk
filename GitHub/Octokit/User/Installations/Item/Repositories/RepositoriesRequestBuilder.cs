...
using Octokit.Client.User.Installations.Item.Repositories.Item;
...
namespace Octokit.Client.User.Installations.Item.Repositories {
    ...
    public class RepositoriesRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.user.installations.item.repositories.item collection</summary>
