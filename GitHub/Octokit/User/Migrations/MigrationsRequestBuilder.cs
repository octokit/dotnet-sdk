...
using Octokit.Client.User.Migrations.Item;
...
using System;
namespace Octokit.Client.User.Migrations {
    /// <summary>
    ...
    public class MigrationsRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.user.migrations.item collection</summary>
