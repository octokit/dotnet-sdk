...
using Octokit.Client.User.Repository_invitations.Item;
...
using System;
namespace Octokit.Client.User.Repository_invitations {
    /// <summary>
    ...
    public class Repository_invitationsRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.user.repository_invitations.item collection</summary>
