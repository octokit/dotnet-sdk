...
using Octokit.Client.User.Ssh_signing_keys.Item;
...
using System;
namespace Octokit.Client.User.Ssh_signing_keys {
    /// <summary>
    ...
    public class Ssh_signing_keysRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.user.ssh_signing_keys.item collection</summary>
