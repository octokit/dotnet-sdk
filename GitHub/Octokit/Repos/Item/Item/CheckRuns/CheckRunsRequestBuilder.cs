...
using Octokit.Client.Repos.Item.Item.CheckRuns.Item;
...
namespace Octokit.Client.Repos.Item.Item.CheckRuns {
    ...
    public class CheckRunsRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.repos.item.item.checkRuns.item collection</summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
            public Octokit.Client.Repos.Item.Item.CheckRuns.CheckRunsPostRequestBodyMember1? CheckRunsPostRequestBodyCheckRunsPostRequestBodyMember1 { get; set; }
#nullable restore
#else
            public Octokit.Client.Repos.Item.Item.CheckRuns.CheckRunsPostRequestBodyMember1 CheckRunsPostRequestBodyCheckRunsPostRequestBodyMember1 { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
            public Octokit.Client.Repos.Item.Item.CheckRuns.CheckRunsPostRequestBodyMember2? CheckRunsPostRequestBodyCheckRunsPostRequestBodyMember2 { get; set; }
#nullable restore
#else
            public Octokit.Client.Repos.Item.Item.CheckRuns.CheckRunsPostRequestBodyMember2 CheckRunsPostRequestBodyCheckRunsPostRequestBodyMember2 { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
            public Octokit.Client.Repos.Item.Item.CheckRuns.CheckRunsPostRequestBodyMember1? CheckRunsPostRequestBodyMember1 { get; set; }
#nullable restore
#else
            public Octokit.Client.Repos.Item.Item.CheckRuns.CheckRunsPostRequestBodyMember1 CheckRunsPostRequestBodyMember1 { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
            public Octokit.Client.Repos.Item.Item.CheckRuns.CheckRunsPostRequestBodyMember2? CheckRunsPostRequestBodyMember2 { get; set; }
#nullable restore
#else
            public Octokit.Client.Repos.Item.Item.CheckRuns.CheckRunsPostRequestBodyMember2 CheckRunsPostRequestBodyMember2 { get; set; }
#endif
            ...
            public static CheckRunsPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
                ...
                if("".Equals(mappingValue, StringComparison.OrdinalIgnoreCase)) {
                    result.CheckRunsPostRequestBodyCheckRunsPostRequestBodyMember1 = new Octokit.Client.Repos.Item.Item.CheckRuns.CheckRunsPostRequestBodyMember1();
                }
                else if("".Equals(mappingValue, StringComparison.OrdinalIgnoreCase)) {
                    result.CheckRunsPostRequestBodyCheckRunsPostRequestBodyMember2 = new Octokit.Client.Repos.Item.Item.CheckRuns.CheckRunsPostRequestBodyMember2();
                }
                else if("".Equals(mappingValue, StringComparison.OrdinalIgnoreCase)) {
                    result.CheckRunsPostRequestBodyMember1 = new Octokit.Client.Repos.Item.Item.CheckRuns.CheckRunsPostRequestBodyMember1();
                }
                else if("".Equals(mappingValue, StringComparison.OrdinalIgnoreCase)) {
                    result.CheckRunsPostRequestBodyMember2 = new Octokit.Client.Repos.Item.Item.CheckRuns.CheckRunsPostRequestBodyMember2();
                }
                return result;
            }
            /// <summary>
            ...
            public virtual void Serialize(ISerializationWriter writer) {
                ...
                if(CheckRunsPostRequestBodyCheckRunsPostRequestBodyMember1 != null) {
                    writer.WriteObjectValue<Octokit.Client.Repos.Item.Item.CheckRuns.CheckRunsPostRequestBodyMember1>(null, CheckRunsPostRequestBodyCheckRunsPostRequestBodyMember1);
                }
                else if(CheckRunsPostRequestBodyCheckRunsPostRequestBodyMember2 != null) {
                    writer.WriteObjectValue<Octokit.Client.Repos.Item.Item.CheckRuns.CheckRunsPostRequestBodyMember2>(null, CheckRunsPostRequestBodyCheckRunsPostRequestBodyMember2);
                }
                else if(CheckRunsPostRequestBodyMember1 != null) {
                    writer.WriteObjectValue<Octokit.Client.Repos.Item.Item.CheckRuns.CheckRunsPostRequestBodyMember1>(null, CheckRunsPostRequestBodyMember1);
                }
                else if(CheckRunsPostRequestBodyMember2 != null) {
                    writer.WriteObjectValue<Octokit.Client.Repos.Item.Item.CheckRuns.CheckRunsPostRequestBodyMember2>(null, CheckRunsPostRequestBodyMember2);
                }
            }
        }
        /// <summary>
        ...
        public class CheckRunsRequestBuilderPostRequestConfiguration : RequestConfiguration<DefaultQueryParameters> {
        }
    }
}
