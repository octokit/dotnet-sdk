...
using System;
namespace GitHub.Octokit.Repos.Item.Item.Tarball.Item {
    /// <summary>
    /// Builds and executes requests for operations under \repos\{owner}\{repo}\tarball\{ref}
    /// </summary>
    public class WithRefItemRequestBuilder : BaseRequestBuilder {
        ...
        public WithRefItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{owner}/{repo}/tarball/{ref}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WithRefItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithRefItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{owner}/{repo}/tarball/{ref}", rawUrl) {
        }
        /// <summary>
