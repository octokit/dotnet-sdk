...
using Octokit.Client.Repos.Item.Item.Actions;
using Octokit.Client.Repos.Item.Item.Activity;
using Octokit.Client.Repos.Item.Item.Assignees;
using Octokit.Client.Repos.Item.Item.Autolinks;
using Octokit.Client.Repos.Item.Item.AutomatedSecurityFixes;
using Octokit.Client.Repos.Item.Item.Branches;
using Octokit.Client.Repos.Item.Item.CheckRuns;
using Octokit.Client.Repos.Item.Item.CheckSuites;
using Octokit.Client.Repos.Item.Item.CodeScanning;
using Octokit.Client.Repos.Item.Item.Codeowners;
using Octokit.Client.Repos.Item.Item.Codespaces;
using Octokit.Client.Repos.Item.Item.Collaborators;
using Octokit.Client.Repos.Item.Item.Comments;
using Octokit.Client.Repos.Item.Item.Commits;
using Octokit.Client.Repos.Item.Item.Community;
using Octokit.Client.Repos.Item.Item.Compare;
using Octokit.Client.Repos.Item.Item.Contents;
using Octokit.Client.Repos.Item.Item.Contributors;
using Octokit.Client.Repos.Item.Item.Dependabot;
using Octokit.Client.Repos.Item.Item.DependencyGraph;
using Octokit.Client.Repos.Item.Item.Deployments;
using Octokit.Client.Repos.Item.Item.Dispatches;
using Octokit.Client.Repos.Item.Item.Environments;
using Octokit.Client.Repos.Item.Item.Events;
using Octokit.Client.Repos.Item.Item.Forks;
using Octokit.Client.Repos.Item.Item.Generate;
using Octokit.Client.Repos.Item.Item.Git;
using Octokit.Client.Repos.Item.Item.Hooks;
using Octokit.Client.Repos.Item.Item.Import;
using Octokit.Client.Repos.Item.Item.Installation;
using Octokit.Client.Repos.Item.Item.InteractionLimits;
using Octokit.Client.Repos.Item.Item.Invitations;
using Octokit.Client.Repos.Item.Item.Issues;
using Octokit.Client.Repos.Item.Item.Keys;
using Octokit.Client.Repos.Item.Item.Labels;
using Octokit.Client.Repos.Item.Item.Languages;
using Octokit.Client.Repos.Item.Item.License;
using Octokit.Client.Repos.Item.Item.MergeUpstream;
using Octokit.Client.Repos.Item.Item.Merges;
using Octokit.Client.Repos.Item.Item.Milestones;
using Octokit.Client.Repos.Item.Item.Notifications;
using Octokit.Client.Repos.Item.Item.Pages;
using Octokit.Client.Repos.Item.Item.PrivateVulnerabilityReporting;
using Octokit.Client.Repos.Item.Item.Projects;
using Octokit.Client.Repos.Item.Item.Properties;
using Octokit.Client.Repos.Item.Item.Pulls;
using Octokit.Client.Repos.Item.Item.Readme;
using Octokit.Client.Repos.Item.Item.Releases;
using Octokit.Client.Repos.Item.Item.Rules;
using Octokit.Client.Repos.Item.Item.Rulesets;
using Octokit.Client.Repos.Item.Item.SecretScanning;
using Octokit.Client.Repos.Item.Item.SecurityAdvisories;
using Octokit.Client.Repos.Item.Item.Stargazers;
using Octokit.Client.Repos.Item.Item.Stats;
using Octokit.Client.Repos.Item.Item.Statuses;
using Octokit.Client.Repos.Item.Item.Subscribers;
using Octokit.Client.Repos.Item.Item.Subscription;
using Octokit.Client.Repos.Item.Item.Tags;
using Octokit.Client.Repos.Item.Item.Tarball;
using Octokit.Client.Repos.Item.Item.Teams;
using Octokit.Client.Repos.Item.Item.Topics;
using Octokit.Client.Repos.Item.Item.Traffic;
using Octokit.Client.Repos.Item.Item.Transfer;
using Octokit.Client.Repos.Item.Item.VulnerabilityAlerts;
using Octokit.Client.Repos.Item.Item.Zipball;
