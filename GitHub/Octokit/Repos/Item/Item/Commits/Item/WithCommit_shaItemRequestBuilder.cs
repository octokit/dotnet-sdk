...
using Octokit.Client.Repos.Item.Item.Commits.Item.BranchesWhereHead;
using Octokit.Client.Repos.Item.Item.Commits.Item.CheckRuns;
using Octokit.Client.Repos.Item.Item.Commits.Item.CheckSuites;
using Octokit.Client.Repos.Item.Item.Commits.Item.Comments;
using Octokit.Client.Repos.Item.Item.Commits.Item.Pulls;
using Octokit.Client.Repos.Item.Item.Commits.Item.Status;
using Octokit.Client.Repos.Item.Item.Commits.Item.Statuses;
...
using System;
namespace Octokit.Client.Repos.Item.Item.Commits.Item {
    /// <summary>
    ...
    public class WithCommit_shaItemRequestBuilder : BaseRequestBuilder {
        ...
        public WithCommit_shaItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{repos%2Did}/{Owner%2Did}/commits/{commits%2Did}{?page*,per_page*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WithCommit_shaItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithCommit_shaItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{repos%2Did}/{Owner%2Did}/commits/{commits%2Did}{?page*,per_page*}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<Commit?> GetAsync(Action<RequestConfiguration<WithCommit_shaItemRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Commit> GetAsync(Action<RequestConfiguration<WithCommit_shaItemRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<WithCommit_shaItemRequestBuilderGetQueryParameters>>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<WithCommit_shaItemRequestBuilderGetQueryParameters>> requestConfiguration = default) {
#endif
        ...
        public class WithCommit_shaItemRequestBuilderGetRequestConfiguration : RequestConfiguration<WithCommit_shaItemRequestBuilderGetQueryParameters> {
        }
    }
}
