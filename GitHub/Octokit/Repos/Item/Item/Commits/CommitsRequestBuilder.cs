...
using Octokit.Client.Repos.Item.Item.Commits.Item;
...
using System;
namespace Octokit.Client.Repos.Item.Item.Commits {
    /// <summary>
    ...
    public class CommitsRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.repos.item.item.commits.item collection</summary>
        ...
        public CommitsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{repos%2Did}/{Owner%2Did}/commits{?sha*,path*,author*,committer*,since*,until*,per_page*,page*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CommitsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CommitsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{repos%2Did}/{Owner%2Did}/commits{?sha*,path*,author*,committer*,since*,until*,per_page*,page*}", rawUrl) {
        }
        /// <summary>
