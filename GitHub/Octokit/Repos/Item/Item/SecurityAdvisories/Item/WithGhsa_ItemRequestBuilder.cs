...
using Octokit.Client.Repos.Item.Item.SecurityAdvisories.Item.Cve;
using Octokit.Client.Repos.Item.Item.SecurityAdvisories.Item.Forks;
...
using System;
namespace Octokit.Client.Repos.Item.Item.SecurityAdvisories.Item {
    /// <summary>
