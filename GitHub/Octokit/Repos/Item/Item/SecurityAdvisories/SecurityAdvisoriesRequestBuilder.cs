...
using Octokit.Client.Repos.Item.Item.SecurityAdvisories.Item;
using Octokit.Client.Repos.Item.Item.SecurityAdvisories.Reports;
...
namespace Octokit.Client.Repos.Item.Item.SecurityAdvisories {
    ...
    public class SecurityAdvisoriesRequestBuilder : BaseRequestBuilder {
        ...
        /// <summary>Gets an item from the Octokit.Client.repos.item.item.securityAdvisories.item collection</summary>
