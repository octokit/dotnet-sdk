...
using Octokit.Client.Repos.Item.Item.Codespaces.Secrets.Item;
using Octokit.Client.Repos.Item.Item.Codespaces.Secrets.PublicKey;
...
using System;
namespace Octokit.Client.Repos.Item.Item.Codespaces.Secrets {
    /// <summary>
    ...
    public class SecretsRequestBuilder : BaseRequestBuilder {
        ...
        /// <summary>Gets an item from the Octokit.Client.repos.item.item.codespaces.secrets.item collection</summary>
