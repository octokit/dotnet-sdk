...
using Octokit.Client.Repos.Item.Item.Pages.Builds.Item;
using Octokit.Client.Repos.Item.Item.Pages.Builds.Latest;
...
using System;
namespace Octokit.Client.Repos.Item.Item.Pages.Builds {
    /// <summary>
    ...
    public class BuildsRequestBuilder : BaseRequestBuilder {
        ...
        /// <summary>Gets an item from the Octokit.Client.repos.item.item.pages.builds.item collection</summary>
...
#nullable restore
        ...
        public class BuildsRequestBuilderGetRequestConfiguration : RequestConfiguration<BuildsRequestBuilderGetQueryParameters> {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class BuildsRequestBuilderPostRequestConfiguration : RequestConfiguration<DefaultQueryParameters> {
        }
    }
}
