...
using Octokit.Client.Repos.Item.Item.Comments.Item;
...
using System;
namespace Octokit.Client.Repos.Item.Item.Comments {
    /// <summary>
    ...
    public class CommentsRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.repos.item.item.comments.item collection</summary>
