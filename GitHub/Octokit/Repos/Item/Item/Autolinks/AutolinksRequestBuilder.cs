...
using Octokit.Client.Repos.Item.Item.Autolinks.Item;
...
using System;
namespace Octokit.Client.Repos.Item.Item.Autolinks {
    /// <summary>
    ...
    public class AutolinksRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.repos.item.item.autolinks.item collection</summary>
