...
namespace GitHub.Octokit.Repos.Item.Item.Releases {
    ...
    public class ReleasesRequestBuilder : BaseRequestBuilder {
        ...
        public ReleasesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{repos%2Did}/{Owner%2Did}/releases{?per_page*,page*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ReleasesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ReleasesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{repos%2Did}/{Owner%2Did}/releases{?per_page*,page*}", rawUrl) {
        }
        /// <summary>
...
#nullable restore
        ...
        public class ReleasesRequestBuilderGetRequestConfiguration : RequestConfiguration<ReleasesRequestBuilderGetQueryParameters> {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class ReleasesRequestBuilderPostRequestConfiguration : RequestConfiguration<DefaultQueryParameters> {
        }
    }
}
