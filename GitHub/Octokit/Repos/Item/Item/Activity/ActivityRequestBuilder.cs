...
#nullable enable
        public async Task<List<GitHub.Octokit.Models.Activity>?> GetAsync(Action<RequestConfiguration<ActivityRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<List<GitHub.Octokit.Models.Activity>> GetAsync(Action<RequestConfiguration<ActivityRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
