...
using System;
namespace Octokit.Client.Repos.Item.Item.Activity {
    /// <summary>
    ...
    public class ActivityRequestBuilder : BaseRequestBuilder {
        ...
        public ActivityRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{repos%2Did}/{Owner%2Did}/activity{?direction*,per_page*,before*,after*,ref*,actor*,time_period*,activity_type*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ActivityRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ActivityRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{repos%2Did}/{Owner%2Did}/activity{?direction*,per_page*,before*,after*,ref*,actor*,time_period*,activity_type*}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<List<Octokit.Client.Models.Activity>?> GetAsync(Action<RequestConfiguration<ActivityRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<List<Octokit.Client.Models.Activity>> GetAsync(Action<RequestConfiguration<ActivityRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
            ...
            var collectionResult = await RequestAdapter.SendCollectionAsync<Octokit.Client.Models.Activity>(requestInfo, Octokit.Client.Models.Activity.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
