...
using Octokit.Client.Repos.Item.Item.Readme.Item;
...
using System;
namespace Octokit.Client.Repos.Item.Item.Readme {
    /// <summary>
    ...
    public class ReadmeRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.repos.item.item.readme.item collection</summary>
