...
using Octokit.Client.Repos.Item.Item.Branches.Item.Protection.Restrictions.Apps;
using Octokit.Client.Repos.Item.Item.Branches.Item.Protection.Restrictions.Teams;
using Octokit.Client.Repos.Item.Item.Branches.Item.Protection.Restrictions.Users;
...
using System;
namespace Octokit.Client.Repos.Item.Item.Branches.Item.Protection.Restrictions {
    /// <summary>
...
#nullable restore
        ...
        public class RestrictionsRequestBuilderDeleteRequestConfiguration : RequestConfiguration<DefaultQueryParameters> {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class RestrictionsRequestBuilderGetRequestConfiguration : RequestConfiguration<DefaultQueryParameters> {
        }
    }
}
