...
using Octokit.Client.Repos.Item.Item.Pulls.Comments.Item.Reactions.Item;
...
using System;
namespace Octokit.Client.Repos.Item.Item.Pulls.Comments.Item.Reactions {
    /// <summary>
    ...
    public class ReactionsRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.repos.item.item.pulls.comments.item.reactions.item collection</summary>
