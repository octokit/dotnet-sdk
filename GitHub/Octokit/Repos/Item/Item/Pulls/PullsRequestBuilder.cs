...
using Octokit.Client.Repos.Item.Item.Pulls.Comments;
using Octokit.Client.Repos.Item.Item.Pulls.Item;
...
namespace Octokit.Client.Repos.Item.Item.Pulls {
    ...
    public class PullsRequestBuilder : BaseRequestBuilder {
        ...
        /// <summary>Gets an item from the Octokit.Client.repos.item.item.pulls.item collection</summary>
