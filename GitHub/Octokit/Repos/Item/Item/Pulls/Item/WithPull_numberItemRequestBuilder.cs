...
using Octokit.Client.Repos.Item.Item.Pulls.Item.Codespaces;
using Octokit.Client.Repos.Item.Item.Pulls.Item.Comments;
using Octokit.Client.Repos.Item.Item.Pulls.Item.Commits;
using Octokit.Client.Repos.Item.Item.Pulls.Item.Files;
using Octokit.Client.Repos.Item.Item.Pulls.Item.Merge;
using Octokit.Client.Repos.Item.Item.Pulls.Item.Requested_reviewers;
using Octokit.Client.Repos.Item.Item.Pulls.Item.Reviews;
using Octokit.Client.Repos.Item.Item.Pulls.Item.UpdateBranch;
...
using System;
namespace Octokit.Client.Repos.Item.Item.Pulls.Item {
    /// <summary>
...
#nullable restore
        ...
        public class WithPull_numberItemRequestBuilderGetRequestConfiguration : RequestConfiguration<DefaultQueryParameters> {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class WithPull_numberItemRequestBuilderPatchRequestConfiguration : RequestConfiguration<DefaultQueryParameters> {
        }
    }
}
