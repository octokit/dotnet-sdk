...
using Octokit.Client.Repos.Item.Item.Pulls.Item.Reviews.Item.Comments;
using Octokit.Client.Repos.Item.Item.Pulls.Item.Reviews.Item.Dismissals;
using Octokit.Client.Repos.Item.Item.Pulls.Item.Reviews.Item.Events;
...
using System;
namespace Octokit.Client.Repos.Item.Item.Pulls.Item.Reviews.Item {
    /// <summary>
...
#nullable restore
        ...
        public class WithReview_ItemRequestBuilderDeleteRequestConfiguration : RequestConfiguration<DefaultQueryParameters> {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class WithReview_ItemRequestBuilderGetRequestConfiguration : RequestConfiguration<DefaultQueryParameters> {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class WithReview_ItemRequestBuilderPutRequestConfiguration : RequestConfiguration<DefaultQueryParameters> {
        }
    }
}
