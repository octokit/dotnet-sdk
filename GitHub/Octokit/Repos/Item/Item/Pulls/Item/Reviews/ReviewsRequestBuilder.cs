...
using Octokit.Client.Repos.Item.Item.Pulls.Item.Reviews.Item;
...
using System;
namespace Octokit.Client.Repos.Item.Item.Pulls.Item.Reviews {
    /// <summary>
    ...
    public class ReviewsRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.repos.item.item.pulls.item.reviews.item collection</summary>
