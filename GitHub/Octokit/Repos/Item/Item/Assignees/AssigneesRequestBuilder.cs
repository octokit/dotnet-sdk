...
using Octokit.Client.Repos.Item.Item.Assignees.Item;
...
using System;
namespace Octokit.Client.Repos.Item.Item.Assignees {
    /// <summary>
    ...
    public class AssigneesRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.repos.item.item.assignees.item collection</summary>
