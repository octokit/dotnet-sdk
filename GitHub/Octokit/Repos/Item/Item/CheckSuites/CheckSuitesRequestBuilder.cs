...
using Octokit.Client.Repos.Item.Item.CheckSuites.Item;
using Octokit.Client.Repos.Item.Item.CheckSuites.Preferences;
...
using System;
namespace Octokit.Client.Repos.Item.Item.CheckSuites {
    /// <summary>
    ...
    public class CheckSuitesRequestBuilder : BaseRequestBuilder {
        ...
        /// <summary>Gets an item from the Octokit.Client.repos.item.item.checkSuites.item collection</summary>
