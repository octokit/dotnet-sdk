...
using Octokit.Client.Repos.Item.Item.Import.Authors.Item;
...
using System;
namespace Octokit.Client.Repos.Item.Item.Import.Authors {
    /// <summary>
    ...
    public class AuthorsRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.repos.item.item.import.authors.item collection</summary>
...
#nullable restore
        ...
        public class AuthorsRequestBuilderGetRequestConfiguration : RequestConfiguration<AuthorsRequestBuilderGetQueryParameters> {
        }
    }
}
