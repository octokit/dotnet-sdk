...
using System;
namespace Octokit.Client.Repos.Item.Item.Statuses.Item {
    /// <summary>
...
#nullable enable
        public async Task<Octokit.Client.Models.Status?> PostAsync(WithShaPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Octokit.Client.Models.Status> PostAsync(WithShaPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<Octokit.Client.Models.Status>(requestInfo, Octokit.Client.Models.Status.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Users with push access in a repository can create commit statuses for a given SHA.Note: there is a limit of 1000 statuses per `sha` and `context` within a repository. Attempts to create more than 1000 statuses will result in a validation error.
        /// </summary>
