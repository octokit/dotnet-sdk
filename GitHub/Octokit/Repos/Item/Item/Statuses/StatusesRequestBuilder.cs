...
using Octokit.Client.Repos.Item.Item.Statuses.Item;
using System.Collections.Generic;
using System.IO;
using System.Linq;
using System.Threading.Tasks;
using System;
namespace Octokit.Client.Repos.Item.Item.Statuses {
    /// <summary>
    ...
    public class StatusesRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.repos.item.item.statuses.item collection</summary>
