...
using Octokit.Client.Repos.Item.Item.Hooks.Item.Deliveries.Item;
...
using System;
namespace Octokit.Client.Repos.Item.Item.Hooks.Item.Deliveries {
    /// <summary>
    ...
    public class DeliveriesRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.repos.item.item.hooks.item.deliveries.item collection</summary>
