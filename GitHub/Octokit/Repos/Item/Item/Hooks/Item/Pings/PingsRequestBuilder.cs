...
using System;
namespace GitHub.Octokit.Repos.Item.Item.Hooks.Item.Pings {
    /// <summary>
    /// Builds and executes requests for operations under \repos\{owner}\{repo}\hooks\{hook_id}\pings
    /// </summary>
    public class PingsRequestBuilder : BaseRequestBuilder {
        ...
        public PingsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{owner}/{repo}/hooks/{hook_id}/pings", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new PingsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public PingsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{owner}/{repo}/hooks/{hook_id}/pings", rawUrl) {
        }
        /// <summary>
