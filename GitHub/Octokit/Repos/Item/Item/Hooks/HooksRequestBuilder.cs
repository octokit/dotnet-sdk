...
using Octokit.Client.Repos.Item.Item.Hooks.Item;
...
using System;
namespace Octokit.Client.Repos.Item.Item.Hooks {
    /// <summary>
    ...
    public class HooksRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.repos.item.item.hooks.item collection</summary>
...
#nullable enable
        public async Task<List<Octokit.Client.Models.Hook>?> GetAsync(Action<RequestConfiguration<HooksRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<List<Octokit.Client.Models.Hook>> GetAsync(Action<RequestConfiguration<HooksRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
            ...
            var collectionResult = await RequestAdapter.SendCollectionAsync<Octokit.Client.Models.Hook>(requestInfo, Octokit.Client.Models.Hook.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Octokit.Client.Models.Hook?> PostAsync(HooksPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Octokit.Client.Models.Hook> PostAsync(HooksPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<Octokit.Client.Models.Hook>(requestInfo, Octokit.Client.Models.Hook.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Lists webhooks for a repository. `last response` may return null if there have not been any deliveries within 30 days.
        /// </summary>
