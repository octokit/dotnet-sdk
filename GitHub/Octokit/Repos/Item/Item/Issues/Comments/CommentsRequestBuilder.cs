...
using Octokit.Client.Repos.Item.Item.Issues.Comments.Item;
...
namespace Octokit.Client.Repos.Item.Item.Issues.Comments {
    ...
    public class CommentsRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.repos.item.item.issues.comments.item collection</summary>
