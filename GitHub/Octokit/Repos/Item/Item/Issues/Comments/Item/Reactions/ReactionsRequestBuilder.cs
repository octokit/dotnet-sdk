...
using Octokit.Client.Repos.Item.Item.Issues.Comments.Item.Reactions.Item;
...
using System;
namespace Octokit.Client.Repos.Item.Item.Issues.Comments.Item.Reactions {
    /// <summary>
    /// Builds and executes requests for operations under \repos\{repos-id}\{Owner-id}\issues\comments\{comment_id}\reactions
    /// </summary>
    public class ReactionsRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.repos.item.item.issues.comments.item.reactions.item collection</summary>
        ...
        public ReactionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{repos%2Did}/{Owner%2Did}/issues/comments/{comment_id}/reactions{?content*,per_page*,page*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ReactionsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ReactionsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{repos%2Did}/{Owner%2Did}/issues/comments/{comment_id}/reactions{?content*,per_page*,page*}", rawUrl) {
        }
        /// <summary>
