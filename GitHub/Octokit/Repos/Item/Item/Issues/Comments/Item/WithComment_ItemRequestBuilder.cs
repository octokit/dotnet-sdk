...
namespace GitHub.Octokit.Repos.Item.Item.Issues.Comments.Item {
    /// <summary>
    /// Builds and executes requests for operations under \repos\{repos-id}\{Owner-id}\issues\comments\{comment_id}
    /// </summary>
    public class WithComment_ItemRequestBuilder : BaseRequestBuilder {
        ...
        public WithComment_ItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{repos%2Did}/{Owner%2Did}/issues/comments/{comment_id}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WithComment_ItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithComment_ItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{repos%2Did}/{Owner%2Did}/issues/comments/{comment_id}", rawUrl) {
        }
        /// <summary>
