...
using Octokit.Client.Repos.Item.Item.Issues.Comments;
using Octokit.Client.Repos.Item.Item.Issues.Events;
using Octokit.Client.Repos.Item.Item.Issues.Item;
...
namespace Octokit.Client.Repos.Item.Item.Issues {
    ...
    public class IssuesRequestBuilder : BaseRequestBuilder {
        ...
        /// <summary>Gets an item from the Octokit.Client.repos.item.item.issues.item collection</summary>
