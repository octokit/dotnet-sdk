...
using Octokit.Client.Repos.Item.Item.Issues.Item.Reactions.Item;
...
using System;
namespace Octokit.Client.Repos.Item.Item.Issues.Item.Reactions {
    /// <summary>
    ...
    public class ReactionsRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.repos.item.item.issues.item.reactions.item collection</summary>
