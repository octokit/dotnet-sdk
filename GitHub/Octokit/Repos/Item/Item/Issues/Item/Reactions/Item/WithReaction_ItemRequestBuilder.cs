...
namespace GitHub.Octokit.Repos.Item.Item.Issues.Item.Reactions.Item {
    /// <summary>
    /// Builds and executes requests for operations under \repos\{owner}\{repo}\issues\{issue_number}\reactions\{reaction_id}
    /// </summary>
    public class WithReaction_ItemRequestBuilder : BaseRequestBuilder {
        ...
        public WithReaction_ItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{owner}/{repo}/issues/{issue_number}/reactions/{reaction_id}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WithReaction_ItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithReaction_ItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{owner}/{repo}/issues/{issue_number}/reactions/{reaction_id}", rawUrl) {
        }
        /// <summary>
