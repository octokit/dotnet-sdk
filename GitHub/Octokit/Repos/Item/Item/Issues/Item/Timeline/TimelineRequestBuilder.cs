...
using System;
namespace Octokit.Client.Repos.Item.Item.Issues.Item.Timeline {
    /// <summary>
    ...
    public class TimelineRequestBuilder : BaseRequestBuilder {
        ...
        public TimelineRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{repos%2Did}/{Owner%2Did}/issues/{issue_number}/timeline{?per_page*,page*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new TimelineRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public TimelineRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{repos%2Did}/{Owner%2Did}/issues/{issue_number}/timeline{?per_page*,page*}", rawUrl) {
        }
        /// <summary>
...
#nullable restore
        ...
        public class TimelineRequestBuilderGetRequestConfiguration : RequestConfiguration<TimelineRequestBuilderGetQueryParameters> {
        }
    }
}
