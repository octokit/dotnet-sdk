...
using Octokit.Client.Repos.Item.Item.Actions.Secrets.Item;
using Octokit.Client.Repos.Item.Item.Actions.Secrets.PublicKey;
...
using System;
namespace Octokit.Client.Repos.Item.Item.Actions.Secrets {
    /// <summary>
    ...
    public class SecretsRequestBuilder : BaseRequestBuilder {
        ...
        /// <summary>Gets an item from the Octokit.Client.repos.item.item.actions.secrets.item collection</summary>
