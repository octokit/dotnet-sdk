...
using Octokit.Client.Repos.Item.Item.Actions.Caches.Item;
...
namespace Octokit.Client.Repos.Item.Item.Actions.Caches {
    ...
    public class CachesRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.repos.item.item.actions.caches.item collection</summary>
