...
using Octokit.Client.Repos.Item.Item.Actions.Artifacts.Item;
...
namespace Octokit.Client.Repos.Item.Item.Actions.Artifacts {
    ...
    public class ArtifactsRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.repos.item.item.actions.artifacts.item collection</summary>
