...
using System;
namespace Octokit.Client.Repos.Item.Item.Actions.Runners.RegistrationToken {
    /// <summary>
    /// Builds and executes requests for operations under \repos\{repos-id}\{Owner-id}\actions\runners\registration-token
    /// </summary>
    public class RegistrationTokenRequestBuilder : BaseRequestBuilder {
        ...
        public RegistrationTokenRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{repos%2Did}/{Owner%2Did}/actions/runners/registration-token", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new RegistrationTokenRequestBuilder and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        public class RegistrationTokenRequestBuilderPostRequestConfiguration : RequestConfiguration<DefaultQueryParameters> {
        }
    }
}
