...
using Octokit.Client.Repos.Item.Item.Actions.Runners.Downloads;
using Octokit.Client.Repos.Item.Item.Actions.Runners.GenerateJitconfig;
using Octokit.Client.Repos.Item.Item.Actions.Runners.Item;
using Octokit.Client.Repos.Item.Item.Actions.Runners.RegistrationToken;
using Octokit.Client.Repos.Item.Item.Actions.Runners.RemoveToken;
...
namespace Octokit.Client.Repos.Item.Item.Actions.Runners {
    ...
    public class RunnersRequestBuilder : BaseRequestBuilder {
        ...
        /// <summary>Gets an item from the Octokit.Client.repos.item.item.actions.runners.item collection</summary>
        ...
        public RunnersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{repos%2Did}/{Owner%2Did}/actions/runners{?name*,per_page*,page*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new RunnersRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RunnersRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{repos%2Did}/{Owner%2Did}/actions/runners{?name*,per_page*,page*}", rawUrl) {
        }
        /// <summary>
