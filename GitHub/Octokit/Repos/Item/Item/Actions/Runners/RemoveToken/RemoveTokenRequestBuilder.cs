...
using System;
namespace Octokit.Client.Repos.Item.Item.Actions.Runners.RemoveToken {
    /// <summary>
...
#nullable restore
        ...
        public class RemoveTokenRequestBuilderPostRequestConfiguration : RequestConfiguration<DefaultQueryParameters> {
        }
    }
}
