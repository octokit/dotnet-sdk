...
using System.Linq;
using System;
namespace Octokit.Client.Repos.Item.Item.Actions.Runners.GenerateJitconfig {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Octokit.Client.Models.Runner? Runner { get; set; }
#nullable restore
#else
        public Octokit.Client.Models.Runner Runner { get; set; }
#endif
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"runner", n => { Runner = n.GetObjectValue<Octokit.Client.Models.Runner>(Octokit.Client.Models.Runner.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<Octokit.Client.Models.Runner>("runner", Runner);
