// <auto-generated/>
using GitHub.Octokit.Repos.Item.Item.Actions.Artifacts;
using GitHub.Octokit.Repos.Item.Item.Actions.Cache;
using GitHub.Octokit.Repos.Item.Item.Actions.Caches;
using GitHub.Octokit.Repos.Item.Item.Actions.Jobs;
using GitHub.Octokit.Repos.Item.Item.Actions.Oidc;
using GitHub.Octokit.Repos.Item.Item.Actions.OrganizationSecrets;
using GitHub.Octokit.Repos.Item.Item.Actions.OrganizationVariables;
using GitHub.Octokit.Repos.Item.Item.Actions.Permissions;
using GitHub.Octokit.Repos.Item.Item.Actions.Runners;
using GitHub.Octokit.Repos.Item.Item.Actions.Runs;
using GitHub.Octokit.Repos.Item.Item.Actions.Secrets;
using GitHub.Octokit.Repos.Item.Item.Actions.Variables;
using GitHub.Octokit.Repos.Item.Item.Actions.Workflows;
...
using System;
namespace GitHub.Octokit.Repos.Item.Item.Actions {
    /// <summary>
    /// Builds and executes requests for operations under \repos\{owner}\{repo}\actions
    /// </summary>
    public class ActionsRequestBuilder : BaseRequestBuilder {
        ...
        public ActionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{owner}/{repo}/actions", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ActionsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ActionsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{owner}/{repo}/actions", rawUrl) {
        }
    }
}
