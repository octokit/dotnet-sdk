...
using Octokit.Client.Repos.Item.Item.Actions.Workflows.Item.Disable;
using Octokit.Client.Repos.Item.Item.Actions.Workflows.Item.Dispatches;
using Octokit.Client.Repos.Item.Item.Actions.Workflows.Item.Enable;
using Octokit.Client.Repos.Item.Item.Actions.Workflows.Item.Runs;
using Octokit.Client.Repos.Item.Item.Actions.Workflows.Item.Timing;
...
using System;
namespace Octokit.Client.Repos.Item.Item.Actions.Workflows.Item {
    /// <summary>
...
#nullable restore
        ...
        public class WithWorkflow_ItemRequestBuilderGetRequestConfiguration : RequestConfiguration<DefaultQueryParameters> {
        }
    }
}
