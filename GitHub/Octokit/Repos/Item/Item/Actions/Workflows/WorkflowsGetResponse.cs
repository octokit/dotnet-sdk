...
#nullable enable
        public List<Octokit.Client.Models.Workflow>? Workflows { get; set; }
#nullable restore
#else
        public List<Octokit.Client.Models.Workflow> Workflows { get; set; }
#endif
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"workflows", n => { Workflows = n.GetCollectionOfObjectValues<Octokit.Client.Models.Workflow>(Octokit.Client.Models.Workflow.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<Octokit.Client.Models.Workflow>("workflows", Workflows);
