...
namespace GitHub.Octokit.Repos.Item.Item.Actions.Runs.Item.Attempts.Item {
    /// <summary>
    /// Builds and executes requests for operations under \repos\{repos-id}\{Owner-id}\actions\runs\{run_id}\attempts\{attempt_number}
    /// </summary>
    public class WithAttempt_numberItemRequestBuilder : BaseRequestBuilder {
        ...
        public WithAttempt_numberItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{repos%2Did}/{Owner%2Did}/actions/runs/{run_id}/attempts/{attempt_number}{?exclude_pull_requests*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WithAttempt_numberItemRequestBuilder and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        public class WithAttempt_numberItemRequestBuilderGetRequestConfiguration : RequestConfiguration<WithAttempt_numberItemRequestBuilderGetQueryParameters> {
        }
    }
}
