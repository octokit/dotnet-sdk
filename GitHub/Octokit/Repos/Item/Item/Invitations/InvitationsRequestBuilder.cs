...
using Octokit.Client.Repos.Item.Item.Invitations.Item;
...
using System;
namespace Octokit.Client.Repos.Item.Item.Invitations {
    /// <summary>
    ...
    public class InvitationsRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.repos.item.item.invitations.item collection</summary>
