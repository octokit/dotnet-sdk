...
using Octokit.Client.Repos.Item.Item.Tags.Protection.Item;
...
using System;
namespace Octokit.Client.Repos.Item.Item.Tags.Protection {
    /// <summary>
    ...
    public class ProtectionRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.repos.item.item.tags.protection.item collection</summary>
...
#nullable restore
        ...
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class ProtectionRequestBuilderPostRequestConfiguration : RequestConfiguration<DefaultQueryParameters> {
        }
    }
}
