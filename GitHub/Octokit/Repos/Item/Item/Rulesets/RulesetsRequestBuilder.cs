...
using Octokit.Client.Repos.Item.Item.Rulesets.Item;
using Octokit.Client.Repos.Item.Item.Rulesets.RuleSuites;
...
using System;
namespace Octokit.Client.Repos.Item.Item.Rulesets {
    /// <summary>
    /// Builds and executes requests for operations under \repos\{repos-id}\{Owner-id}\rulesets
    /// </summary>
    public class RulesetsRequestBuilder : BaseRequestBuilder {
        ...
        /// <summary>Gets an item from the Octokit.Client.repos.item.item.rulesets.item collection</summary>
        ...
        public RulesetsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{repos%2Did}/{Owner%2Did}/rulesets{?per_page*,page*,includes_parents*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new RulesetsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RulesetsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{repos%2Did}/{Owner%2Did}/rulesets{?per_page*,page*,includes_parents*}", rawUrl) {
        }
        /// <summary>
...
#nullable restore
        ...
        public class RulesetsRequestBuilderGetRequestConfiguration : RequestConfiguration<RulesetsRequestBuilderGetQueryParameters> {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class RulesetsRequestBuilderPostRequestConfiguration : RequestConfiguration<DefaultQueryParameters> {
        }
    }
}
