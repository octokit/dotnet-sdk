...
using Octokit.Client.Repos.Item.Item.Rulesets.RuleSuites.Item;
...
using System;
namespace Octokit.Client.Repos.Item.Item.Rulesets.RuleSuites {
    /// <summary>
    ...
    public class RuleSuitesRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.repos.item.item.rulesets.ruleSuites.item collection</summary>
...
#nullable restore
        ...
        public async Task<List<GitHub.Octokit.Models.RuleSuites>> GetAsync(Action<RequestConfiguration<RuleSuitesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            var collectionResult = await RequestAdapter.SendCollectionAsync<Octokit.Client.Models.RuleSuites>(requestInfo, Octokit.Client.Models.RuleSuites.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
