...
using Octokit.Client.Repos.Item.Item.Dependabot.Alerts.Item;
...
namespace Octokit.Client.Repos.Item.Item.Dependabot.Alerts {
    ...
    public class AlertsRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.repos.item.item.dependabot.alerts.item collection</summary>
