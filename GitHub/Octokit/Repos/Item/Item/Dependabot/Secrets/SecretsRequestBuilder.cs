...
using Octokit.Client.Repos.Item.Item.Dependabot.Secrets.Item;
using Octokit.Client.Repos.Item.Item.Dependabot.Secrets.PublicKey;
...
using System;
namespace Octokit.Client.Repos.Item.Item.Dependabot.Secrets {
    /// <summary>
    ...
    public class SecretsRequestBuilder : BaseRequestBuilder {
        ...
        /// <summary>Gets an item from the Octokit.Client.repos.item.item.dependabot.secrets.item collection</summary>
