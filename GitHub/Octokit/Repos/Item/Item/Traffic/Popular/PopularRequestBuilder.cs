...
using Octokit.Client.Repos.Item.Item.Traffic.Popular.Paths;
using Octokit.Client.Repos.Item.Item.Traffic.Popular.Referrers;
using System.Collections.Generic;
using System.IO;
using System.Linq;
using System.Threading.Tasks;
using System;
namespace Octokit.Client.Repos.Item.Item.Traffic.Popular {
    /// <summary>
    /// Builds and executes requests for operations under \repos\{repos-id}\{Owner-id}\traffic\popular
    /// </summary>
    public class PopularRequestBuilder : BaseRequestBuilder {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public PopularRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{repos%2Did}/{Owner%2Did}/traffic/popular", rawUrl) {
        }
    }
}
