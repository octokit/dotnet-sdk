...
using Octokit.Client.Repos.Item.Item.CodeScanning.Codeql.Databases.Item;
...
using System;
namespace Octokit.Client.Repos.Item.Item.CodeScanning.Codeql.Databases {
    /// <summary>
    ...
    public class DatabasesRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.repos.item.item.codeScanning.codeql.databases.item collection</summary>
