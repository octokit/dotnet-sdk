...
using Octokit.Client.Repos.Item.Item.CodeScanning.Sarifs.Item;
...
using System;
namespace Octokit.Client.Repos.Item.Item.CodeScanning.Sarifs {
    /// <summary>
    /// Builds and executes requests for operations under \repos\{repos-id}\{Owner-id}\code-scanning\sarifs
    /// </summary>
    public class SarifsRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.repos.item.item.codeScanning.sarifs.item collection</summary>
        ...
        public SarifsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{repos%2Did}/{Owner%2Did}/code-scanning/sarifs", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SarifsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SarifsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{repos%2Did}/{Owner%2Did}/code-scanning/sarifs", rawUrl) {
        }
        /// <summary>
...
#nullable restore
        ...
        public class SarifsRequestBuilderPostRequestConfiguration : RequestConfiguration<DefaultQueryParameters> {
        }
    }
}
