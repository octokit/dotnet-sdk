...
using Octokit.Client.Repos.Item.Item.CodeScanning.Alerts.Item;
...
using System;
namespace Octokit.Client.Repos.Item.Item.CodeScanning.Alerts {
    /// <summary>
    ...
    public class AlertsRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.repos.item.item.codeScanning.alerts.item collection</summary>
