...
using Octokit.Client.Repos.Item.Item.CodeScanning.Analyses.Item;
...
namespace Octokit.Client.Repos.Item.Item.CodeScanning.Analyses {
    ...
    public class AnalysesRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.repos.item.item.codeScanning.analyses.item collection</summary>
...
#nullable restore
        ...
        public class AnalysesRequestBuilderGetRequestConfiguration : RequestConfiguration<AnalysesRequestBuilderGetQueryParameters> {
        }
    }
}
