...
using Octokit.Client.Repos.Item.Item.Collaborators.Item;
...
using System;
namespace Octokit.Client.Repos.Item.Item.Collaborators {
    /// <summary>
    ...
    public class CollaboratorsRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.repos.item.item.collaborators.item collection</summary>
