...
using Octokit.Client.Repos.Item.Item.Rules.Branches.Item;
using System.Collections.Generic;
using System.IO;
using System.Linq;
using System.Threading.Tasks;
using System;
namespace Octokit.Client.Repos.Item.Item.Rules.Branches {
    /// <summary>
    ...
    public class BranchesRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.repos.item.item.rules.branches.item collection</summary>
