...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
            public Octokit.Client.Models.ContentFile? ContentFile { get; set; }
#nullable restore
#else
            public Octokit.Client.Models.ContentFile ContentFile { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
            public Octokit.Client.Models.ContentSubmodule? ContentSubmodule { get; set; }
#nullable restore
#else
            public Octokit.Client.Models.ContentSubmodule ContentSubmodule { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
            public Octokit.Client.Models.ContentSymlink? ContentSymlink { get; set; }
#nullable restore
#else
            public Octokit.Client.Models.ContentSymlink ContentSymlink { get; set; }
#endif
...
#nullable restore
            ...
            public static WithPathGetResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
                ...
                if("content-file".Equals(mappingValue, StringComparison.OrdinalIgnoreCase)) {
                    result.ContentFile = new Octokit.Client.Models.ContentFile();
                }
                else if("content-submodule".Equals(mappingValue, StringComparison.OrdinalIgnoreCase)) {
                    result.ContentSubmodule = new Octokit.Client.Models.ContentSubmodule();
                }
            ...
            public virtual void Serialize(ISerializationWriter writer) {
                ...
                if(ContentFile != null) {
                    writer.WriteObjectValue<Octokit.Client.Models.ContentFile>(null, ContentFile);
                }
                else if(ContentSubmodule != null) {
                    writer.WriteObjectValue<Octokit.Client.Models.ContentSubmodule>(null, ContentSubmodule);
                }
                else if(ContentSymlink != null) {
