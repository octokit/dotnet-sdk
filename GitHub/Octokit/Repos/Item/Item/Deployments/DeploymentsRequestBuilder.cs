...
using Octokit.Client.Repos.Item.Item.Deployments.Item;
...
using System;
namespace Octokit.Client.Repos.Item.Item.Deployments {
    /// <summary>
    ...
    public class DeploymentsRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.repos.item.item.deployments.item collection</summary>
