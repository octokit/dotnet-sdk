...
using Octokit.Client.Repos.Item.Item.Environments.Item.DeploymentBranchPolicies.Item;
...
namespace Octokit.Client.Repos.Item.Item.Environments.Item.DeploymentBranchPolicies {
    ...
    public class DeploymentBranchPoliciesRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.repos.item.item.environments.item.deploymentBranchPolicies.item collection</summary>
