...
using Octokit.Client.Repos.Item.Item.Git.Trees.Item;
...
using System;
namespace Octokit.Client.Repos.Item.Item.Git.Trees {
    /// <summary>
    ...
    public class TreesRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.repos.item.item.git.trees.item collection</summary>
...
#nullable restore
        ...
        public class TreesRequestBuilderPostRequestConfiguration : RequestConfiguration<DefaultQueryParameters> {
        }
    }
}
