...
using Octokit.Client.Repos.Item.Item.Git.Commits.Item;
...
namespace Octokit.Client.Repos.Item.Item.Git.Commits {
    ...
    public class CommitsRequestBuilder : BaseRequestBuilder {
        ...
        public CommitsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{repos%2Did}/{Owner%2Did}/git/commits", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CommitsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CommitsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{repos%2Did}/{Owner%2Did}/git/commits", rawUrl) {
        }
        /// <summary>
...
#nullable restore
        ...
        public class CommitsRequestBuilderPostRequestConfiguration : RequestConfiguration<DefaultQueryParameters> {
        }
    }
}
