...
using System;
namespace Octokit.Client.Repos.Item.Item.Git.Commits.Item {
    /// <summary>
    /// Builds and executes requests for operations under \repos\{repos-id}\{Owner-id}\git\commits\{commit_sha}
    /// </summary>
    public class WithCommit_shaItemRequestBuilder : BaseRequestBuilder {
        ...
        public WithCommit_shaItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{repos%2Did}/{Owner%2Did}/git/commits/{commit_sha}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WithCommit_shaItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithCommit_shaItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{repos%2Did}/{Owner%2Did}/git/commits/{commit_sha}", rawUrl) {
        }
        /// <summary>
...
#nullable restore
        ...
        public class WithCommit_shaItemRequestBuilderGetRequestConfiguration : RequestConfiguration<DefaultQueryParameters> {
        }
    }
}
