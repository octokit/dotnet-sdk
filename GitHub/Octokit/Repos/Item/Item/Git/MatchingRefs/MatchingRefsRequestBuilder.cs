...
using Octokit.Client.Repos.Item.Item.Git.MatchingRefs.Item;
using System.Collections.Generic;
using System.IO;
using System.Linq;
using System.Threading.Tasks;
using System;
namespace Octokit.Client.Repos.Item.Item.Git.MatchingRefs {
    /// <summary>
    ...
    public class MatchingRefsRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.repos.item.item.git.matchingRefs.item collection</summary>
