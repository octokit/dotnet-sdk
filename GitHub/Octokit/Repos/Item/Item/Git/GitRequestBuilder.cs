...
using Octokit.Client.Repos.Item.Item.Git.Blobs;
using Octokit.Client.Repos.Item.Item.Git.Commits;
using Octokit.Client.Repos.Item.Item.Git.MatchingRefs;
using Octokit.Client.Repos.Item.Item.Git.Ref;
using Octokit.Client.Repos.Item.Item.Git.Refs;
using Octokit.Client.Repos.Item.Item.Git.Tags;
using Octokit.Client.Repos.Item.Item.Git.Trees;
using System.Collections.Generic;
using System.IO;
using System.Linq;
using System.Threading.Tasks;
using System;
namespace Octokit.Client.Repos.Item.Item.Git {
    /// <summary>
