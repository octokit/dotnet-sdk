...
using Octokit.Client.Repos.Item.Item.Git.Blobs.Item;
...
namespace Octokit.Client.Repos.Item.Item.Git.Blobs {
    ...
    public class BlobsRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.repos.item.item.git.blobs.item collection</summary>
...
#nullable restore
        ...
        public class BlobsRequestBuilderPostRequestConfiguration : RequestConfiguration<DefaultQueryParameters> {
        }
    }
}
