...
using Octokit.Client.Repos.Item.Item.DependencyGraph.Compare.Item;
using System.Collections.Generic;
using System.IO;
using System.Linq;
using System.Threading.Tasks;
using System;
namespace Octokit.Client.Repos.Item.Item.DependencyGraph.Compare {
    /// <summary>
    ...
    public class CompareRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.repos.item.item.dependencyGraph.compare.item collection</summary>
