// <auto-generated/>
using GitHub.Octokit.Markdown.Raw;
...
#nullable enable
        public async Task<Stream?> PostAsync(MarkdownPostRequestBody body, Action<MarkdownRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Stream> PostAsync(MarkdownPostRequestBody body, Action<MarkdownRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(MarkdownPostRequestBody body, Action<MarkdownRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(MarkdownPostRequestBody body, Action<MarkdownRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new MarkdownRequestBuilderPostRequestConfiguration();
        ...
        /// </summary>
        public class MarkdownRequestBuilderPostRequestConfiguration {
            /// <summary>Request headers</summary>
            public RequestHeaders Headers { get; set; }
            /// <summary>Request options</summary>
            public IList<IRequestOption> Options { get; set; }
            /// <summary>
            /// Instantiates a new markdownRequestBuilderPostRequestConfiguration and sets the default values.
            /// </summary>
            public MarkdownRequestBuilderPostRequestConfiguration() {
