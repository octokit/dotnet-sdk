// <auto-generated/>
using GitHub.Octokit.Networks.Item.Item;
...
using System;
namespace GitHub.Octokit.Networks.Item {
    /// <summary>
    /// Builds and executes requests for operations under \networks\{owner}
    /// </summary>
    public class WithOwnerItemRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the GitHub.Octokit.networks.item.item collection</summary>
