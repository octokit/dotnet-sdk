...
using Octokit.Client.Networks.Item.Item;
using System.Collections.Generic;
using System.IO;
using System.Linq;
using System.Threading.Tasks;
using System;
namespace Octokit.Client.Networks.Item {
    /// <summary>
    /// Builds and executes requests for operations under \networks\{owner}
    /// </summary>
    public class WithOwnerItemRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.networks.item.item collection</summary>
