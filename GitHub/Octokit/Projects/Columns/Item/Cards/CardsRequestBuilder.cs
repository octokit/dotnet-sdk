...
using System;
namespace Octokit.Client.Projects.Columns.Item.Cards {
    /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
            public Octokit.Client.Projects.Columns.Item.Cards.CardsPostRequestBodyMember1? CardsPostRequestBodyCardsPostRequestBodyMember1 { get; set; }
#nullable restore
#else
            public Octokit.Client.Projects.Columns.Item.Cards.CardsPostRequestBodyMember1 CardsPostRequestBodyCardsPostRequestBodyMember1 { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
            public Octokit.Client.Projects.Columns.Item.Cards.CardsPostRequestBodyMember2? CardsPostRequestBodyCardsPostRequestBodyMember2 { get; set; }
#nullable restore
#else
            public Octokit.Client.Projects.Columns.Item.Cards.CardsPostRequestBodyMember2 CardsPostRequestBodyCardsPostRequestBodyMember2 { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
            public Octokit.Client.Projects.Columns.Item.Cards.CardsPostRequestBodyMember1? CardsPostRequestBodyMember1 { get; set; }
#nullable restore
#else
            public Octokit.Client.Projects.Columns.Item.Cards.CardsPostRequestBodyMember1 CardsPostRequestBodyMember1 { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
            public Octokit.Client.Projects.Columns.Item.Cards.CardsPostRequestBodyMember2? CardsPostRequestBodyMember2 { get; set; }
#nullable restore
#else
            public Octokit.Client.Projects.Columns.Item.Cards.CardsPostRequestBodyMember2 CardsPostRequestBodyMember2 { get; set; }
#endif
            ...
            public static CardsPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
                ...
                if("".Equals(mappingValue, StringComparison.OrdinalIgnoreCase)) {
                    result.CardsPostRequestBodyCardsPostRequestBodyMember1 = new Octokit.Client.Projects.Columns.Item.Cards.CardsPostRequestBodyMember1();
                }
                else if("".Equals(mappingValue, StringComparison.OrdinalIgnoreCase)) {
                    result.CardsPostRequestBodyCardsPostRequestBodyMember2 = new Octokit.Client.Projects.Columns.Item.Cards.CardsPostRequestBodyMember2();
                }
                else if("".Equals(mappingValue, StringComparison.OrdinalIgnoreCase)) {
                    result.CardsPostRequestBodyMember1 = new Octokit.Client.Projects.Columns.Item.Cards.CardsPostRequestBodyMember1();
                }
                else if("".Equals(mappingValue, StringComparison.OrdinalIgnoreCase)) {
                    result.CardsPostRequestBodyMember2 = new Octokit.Client.Projects.Columns.Item.Cards.CardsPostRequestBodyMember2();
                }
                return result;
            }
            /// <summary>
            ...
            public virtual void Serialize(ISerializationWriter writer) {
                ...
                if(CardsPostRequestBodyCardsPostRequestBodyMember1 != null) {
                    writer.WriteObjectValue<Octokit.Client.Projects.Columns.Item.Cards.CardsPostRequestBodyMember1>(null, CardsPostRequestBodyCardsPostRequestBodyMember1);
                }
                else if(CardsPostRequestBodyCardsPostRequestBodyMember2 != null) {
                    writer.WriteObjectValue<Octokit.Client.Projects.Columns.Item.Cards.CardsPostRequestBodyMember2>(null, CardsPostRequestBodyCardsPostRequestBodyMember2);
                }
                else if(CardsPostRequestBodyMember1 != null) {
                    writer.WriteObjectValue<Octokit.Client.Projects.Columns.Item.Cards.CardsPostRequestBodyMember1>(null, CardsPostRequestBodyMember1);
                }
                else if(CardsPostRequestBodyMember2 != null) {
                    writer.WriteObjectValue<Octokit.Client.Projects.Columns.Item.Cards.CardsPostRequestBodyMember2>(null, CardsPostRequestBodyMember2);
                }
            }
        }
        /// <summary>
...
#nullable restore
        ...
        public class CardsRequestBuilderGetRequestConfiguration : RequestConfiguration<CardsRequestBuilderGetQueryParameters> {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
        /// </summary>
