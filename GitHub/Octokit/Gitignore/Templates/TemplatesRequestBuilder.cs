...
using Octokit.Client.Gitignore.Templates.Item;
...
using System;
namespace Octokit.Client.Gitignore.Templates {
    /// <summary>
    ...
    public class TemplatesRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.gitignore.templates.item collection</summary>
