...
using Octokit.Client.Gists.Item;
using Octokit.Client.Gists.Public;
using Octokit.Client.Gists.Starred;
...
namespace Octokit.Client.Gists {
    ...
    public class GistsRequestBuilder : BaseRequestBuilder {
        ...
        /// <summary>Gets an item from the Octokit.Client.gists.item collection</summary>
...
#nullable restore
        ...
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class GistsRequestBuilderPostRequestConfiguration : RequestConfiguration<DefaultQueryParameters> {
        }
    }
}
