...
using Octokit.Client.Gists.Item.Comments;
using Octokit.Client.Gists.Item.Commits;
using Octokit.Client.Gists.Item.Forks;
using Octokit.Client.Gists.Item.Item;
using Octokit.Client.Gists.Item.Star;
...
namespace Octokit.Client.Gists.Item {
    ...
    public class WithGist_ItemRequestBuilder : BaseRequestBuilder {
        ...
        /// <summary>Gets an item from the Octokit.Client.gists.item.item collection</summary>
