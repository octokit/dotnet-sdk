...
using Octokit.Client.Teams.Item.Projects.Item;
...
using System;
namespace Octokit.Client.Teams.Item.Projects {
    /// <summary>
    ...
    public class ProjectsRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.teams.item.projects.item collection</summary>
