...
using Octokit.Client.Teams.Item.Memberships.Item;
using System.Collections.Generic;
using System.IO;
using System.Linq;
using System.Threading.Tasks;
using System;
namespace Octokit.Client.Teams.Item.Memberships {
    /// <summary>
    ...
    public class MembershipsRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.teams.item.memberships.item collection</summary>
