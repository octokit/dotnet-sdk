...
using Octokit.Client.Teams.Item.Discussions;
using Octokit.Client.Teams.Item.Invitations;
using Octokit.Client.Teams.Item.Members;
using Octokit.Client.Teams.Item.Memberships;
using Octokit.Client.Teams.Item.Projects;
using Octokit.Client.Teams.Item.Repos;
using Octokit.Client.Teams.Item.Teams;
...
using System;
namespace Octokit.Client.Teams.Item {
    /// <summary>
    ...
    public class WithTeam_ItemRequestBuilder : BaseRequestBuilder {
        ...
        [Obsolete("")]
        public Octokit.Client.Teams.Item.Teams.TeamsRequestBuilder Teams { get =>
            new Octokit.Client.Teams.Item.Teams.TeamsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
...
#nullable restore
        ...
        public class WithTeam_ItemRequestBuilderDeleteRequestConfiguration : RequestConfiguration<DefaultQueryParameters> {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
        /// </summary>
        ...
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class WithTeam_ItemRequestBuilderPatchRequestConfiguration : RequestConfiguration<DefaultQueryParameters> {
        }
    }
}
