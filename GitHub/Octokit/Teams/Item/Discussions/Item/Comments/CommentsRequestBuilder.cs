...
using Octokit.Client.Teams.Item.Discussions.Item.Comments.Item;
...
namespace Octokit.Client.Teams.Item.Discussions.Item.Comments {
    ...
    public class CommentsRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.teams.item.discussions.item.comments.item collection</summary>
