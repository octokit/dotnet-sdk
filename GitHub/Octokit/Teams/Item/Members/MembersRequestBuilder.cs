...
using Octokit.Client.Teams.Item.Members.Item;
...
using System;
namespace Octokit.Client.Teams.Item.Members {
    /// <summary>
    ...
    public class MembersRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.teams.item.members.item collection</summary>
