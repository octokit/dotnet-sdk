...
using Octokit.Client.Orgs.Item.SecurityManagers.Teams.Item;
using System.Collections.Generic;
using System.IO;
using System.Linq;
using System.Threading.Tasks;
using System;
namespace Octokit.Client.Orgs.Item.SecurityManagers.Teams {
    /// <summary>
    ...
    public class TeamsRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.orgs.item.securityManagers.teams.item collection</summary>
