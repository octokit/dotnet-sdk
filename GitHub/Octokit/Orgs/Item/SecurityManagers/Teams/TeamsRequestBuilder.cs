// <auto-generated/>
using GitHub.Octokit.Orgs.Item.SecurityManagers.Teams.Item;
...
using System;
namespace GitHub.Octokit.Orgs.Item.SecurityManagers.Teams {
    /// <summary>
    ...
    public class TeamsRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the GitHub.Octokit.orgs.item.securityManagers.teams.item collection</summary>
