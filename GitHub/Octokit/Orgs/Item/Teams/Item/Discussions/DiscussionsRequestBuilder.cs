...
using Octokit.Client.Orgs.Item.Teams.Item.Discussions.Item;
...
using System;
namespace Octokit.Client.Orgs.Item.Teams.Item.Discussions {
    /// <summary>
    ...
    public class DiscussionsRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.orgs.item.teams.item.discussions.item collection</summary>
