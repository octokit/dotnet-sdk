...
using Octokit.Client.Orgs.Item.Teams.Item.Discussions.Item.Comments.Item;
...
using System;
namespace Octokit.Client.Orgs.Item.Teams.Item.Discussions.Item.Comments {
    /// <summary>
    ...
    public class CommentsRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.orgs.item.teams.item.discussions.item.comments.item collection</summary>
