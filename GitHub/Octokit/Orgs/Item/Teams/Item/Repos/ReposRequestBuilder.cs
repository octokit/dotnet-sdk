...
using Octokit.Client.Orgs.Item.Teams.Item.Repos.Item;
...
using System;
namespace Octokit.Client.Orgs.Item.Teams.Item.Repos {
    /// <summary>
    ...
    public class ReposRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.orgs.item.teams.item.repos.item collection</summary>
