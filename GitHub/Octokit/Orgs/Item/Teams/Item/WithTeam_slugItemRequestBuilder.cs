...
using Octokit.Client.Orgs.Item.Teams.Item.Discussions;
using Octokit.Client.Orgs.Item.Teams.Item.Invitations;
using Octokit.Client.Orgs.Item.Teams.Item.Members;
using Octokit.Client.Orgs.Item.Teams.Item.Memberships;
using Octokit.Client.Orgs.Item.Teams.Item.Projects;
using Octokit.Client.Orgs.Item.Teams.Item.Repos;
using Octokit.Client.Orgs.Item.Teams.Item.Teams;
...
using System;
namespace Octokit.Client.Orgs.Item.Teams.Item {
    /// <summary>
    ...
    public class WithTeam_slugItemRequestBuilder : BaseRequestBuilder {
        ...
        public Octokit.Client.Orgs.Item.Teams.Item.Teams.TeamsRequestBuilder Teams { get =>
            new Octokit.Client.Orgs.Item.Teams.Item.Teams.TeamsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class WithTeam_slugItemRequestBuilderGetRequestConfiguration : RequestConfiguration<DefaultQueryParameters> {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class WithTeam_slugItemRequestBuilderPatchRequestConfiguration : RequestConfiguration<DefaultQueryParameters> {
        }
    }
}
