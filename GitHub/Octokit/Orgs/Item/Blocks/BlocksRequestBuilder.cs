...
using Octokit.Client.Orgs.Item.Blocks.Item;
...
using System;
namespace Octokit.Client.Orgs.Item.Blocks {
    /// <summary>
    /// Builds and executes requests for operations under \orgs\{org}\blocks
    /// </summary>
    public class BlocksRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.orgs.item.blocks.item collection</summary>
