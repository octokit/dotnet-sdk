...
using Octokit.Client.Orgs.Item.Codespaces.Secrets.Item.Repositories.Item;
...
using System;
namespace Octokit.Client.Orgs.Item.Codespaces.Secrets.Item.Repositories {
    /// <summary>
    ...
    public class RepositoriesRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.orgs.item.codespaces.secrets.item.repositories.item collection</summary>
