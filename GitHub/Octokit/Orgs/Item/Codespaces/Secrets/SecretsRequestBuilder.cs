...
using Octokit.Client.Orgs.Item.Codespaces.Secrets.Item;
using Octokit.Client.Orgs.Item.Codespaces.Secrets.PublicKey;
...
namespace Octokit.Client.Orgs.Item.Codespaces.Secrets {
    ...
    public class SecretsRequestBuilder : BaseRequestBuilder {
        ...
        /// <summary>Gets an item from the Octokit.Client.orgs.item.codespaces.secrets.item collection</summary>
