...
using Octokit.Client.Orgs.Item.OrganizationRoles.Teams.Item;
using System.Collections.Generic;
using System.IO;
using System.Linq;
using System.Threading.Tasks;
using System;
namespace Octokit.Client.Orgs.Item.OrganizationRoles.Teams {
    /// <summary>
    ...
    public class TeamsRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.orgs.item.organizationRoles.teams.item collection</summary>
