// <auto-generated/>
using GitHub.Octokit.Orgs.Item.OrganizationRoles.Teams.Item;
...
using System;
namespace GitHub.Octokit.Orgs.Item.OrganizationRoles.Teams {
    /// <summary>
    ...
    public class TeamsRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the GitHub.Octokit.orgs.item.organizationRoles.teams.item collection</summary>
