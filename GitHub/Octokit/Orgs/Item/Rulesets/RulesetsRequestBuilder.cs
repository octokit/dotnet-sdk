...
using Octokit.Client.Orgs.Item.Rulesets.Item;
using Octokit.Client.Orgs.Item.Rulesets.RuleSuites;
...
using System;
namespace Octokit.Client.Orgs.Item.Rulesets {
    /// <summary>
    ...
    public class RulesetsRequestBuilder : BaseRequestBuilder {
        ...
        /// <summary>Gets an item from the Octokit.Client.orgs.item.rulesets.item collection</summary>
