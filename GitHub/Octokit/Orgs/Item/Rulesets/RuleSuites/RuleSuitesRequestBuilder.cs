...
using Octokit.Client.Orgs.Item.Rulesets.RuleSuites.Item;
...
namespace Octokit.Client.Orgs.Item.Rulesets.RuleSuites {
    ...
    public class RuleSuitesRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.orgs.item.rulesets.ruleSuites.item collection</summary>
