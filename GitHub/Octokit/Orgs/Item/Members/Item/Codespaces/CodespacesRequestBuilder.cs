...
using Octokit.Client.Orgs.Item.Members.Item.Codespaces.Item;
...
using System;
namespace Octokit.Client.Orgs.Item.Members.Item.Codespaces {
    /// <summary>
    ...
    public class CodespacesRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.orgs.item.members.item.codespaces.item collection</summary>
