...
using System;
namespace Octokit.Client.Orgs.Item.Members.Item.Copilot {
    /// <summary>
...
#nullable restore
        ...
        public class CopilotRequestBuilderGetRequestConfiguration : RequestConfiguration<DefaultQueryParameters> {
        }
    }
}
