...
using Octokit.Client.Orgs.Item.Members.Item.Codespaces;
using Octokit.Client.Orgs.Item.Members.Item.Copilot;
...
using System;
namespace Octokit.Client.Orgs.Item.Members.Item {
    /// <summary>
