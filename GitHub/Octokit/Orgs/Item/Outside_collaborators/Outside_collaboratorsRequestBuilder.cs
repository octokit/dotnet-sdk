...
using Octokit.Client.Orgs.Item.Outside_collaborators.Item;
...
namespace Octokit.Client.Orgs.Item.Outside_collaborators {
    ...
    public class Outside_collaboratorsRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.orgs.item.outside_collaborators.item collection</summary>
