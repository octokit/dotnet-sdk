// <auto-generated/>
using GitHub.Octokit.Orgs.Item.Item.Item;
...
using System;
namespace GitHub.Octokit.Orgs.Item.Item {
    /// <summary>
    ...
    public class WithSecurity_productItemRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the GitHub.Octokit.orgs.item.item.item collection</summary>
        ...
        public WithEnablementItemRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("enablement", position);
            return new WithEnablementItemRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
        /// Instantiates a new WithSecurity_productItemRequestBuilder and sets the default values.
        /// </summary>
