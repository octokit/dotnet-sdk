...
using Octokit.Client.Orgs.Item.Dependabot.Secrets.Item.Repositories.Item;
...
using System;
namespace Octokit.Client.Orgs.Item.Dependabot.Secrets.Item.Repositories {
    /// <summary>
    ...
    public class RepositoriesRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.orgs.item.dependabot.secrets.item.repositories.item collection</summary>
