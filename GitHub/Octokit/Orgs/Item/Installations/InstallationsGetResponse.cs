...
#nullable enable
        public List<Octokit.Client.Models.Installation>? Installations { get; set; }
#nullable restore
#else
        public List<Octokit.Client.Models.Installation> Installations { get; set; }
#endif
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                {"installations", n => { Installations = n.GetCollectionOfObjectValues<Octokit.Client.Models.Installation>(Octokit.Client.Models.Installation.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<Octokit.Client.Models.Installation>("installations", Installations);
