...
using Octokit.Client.Orgs.Item.Actions.Runners.Item.Labels.Item;
...
using System;
namespace Octokit.Client.Orgs.Item.Actions.Runners.Item.Labels {
    /// <summary>
    ...
    public class LabelsRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.orgs.item.actions.runners.item.labels.item collection</summary>
