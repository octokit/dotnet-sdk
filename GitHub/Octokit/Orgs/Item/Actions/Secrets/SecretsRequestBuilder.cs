...
using Octokit.Client.Orgs.Item.Actions.Secrets.Item;
using Octokit.Client.Orgs.Item.Actions.Secrets.PublicKey;
...
namespace Octokit.Client.Orgs.Item.Actions.Secrets {
    ...
    public class SecretsRequestBuilder : BaseRequestBuilder {
        ...
        /// <summary>Gets an item from the Octokit.Client.orgs.item.actions.secrets.item collection</summary>
