...
using Octokit.Client.Orgs.Item.Actions.Secrets.Item.Repositories.Item;
...
namespace Octokit.Client.Orgs.Item.Actions.Secrets.Item.Repositories {
    ...
    public class RepositoriesRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.orgs.item.actions.secrets.item.repositories.item collection</summary>
