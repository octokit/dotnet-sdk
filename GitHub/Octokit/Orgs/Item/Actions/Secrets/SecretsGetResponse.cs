...
using System.Linq;
using System;
namespace Octokit.Client.Orgs.Item.Actions.Secrets {
...
#nullable enable
        public List<OrganizationActionsSecret>? Secrets { get; set; }
#nullable restore
#else
        public List<OrganizationActionsSecret> Secrets { get; set; }
#endif
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                {"secrets", n => { Secrets = n.GetCollectionOfObjectValues<OrganizationActionsSecret>(OrganizationActionsSecret.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<OrganizationActionsSecret>("secrets", Secrets);
