...
using Octokit.Client.Orgs.Item.Actions.Variables.Item.Repositories.Item;
...
namespace Octokit.Client.Orgs.Item.Actions.Variables.Item.Repositories {
    ...
    public class RepositoriesRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.orgs.item.actions.variables.item.repositories.item collection</summary>
