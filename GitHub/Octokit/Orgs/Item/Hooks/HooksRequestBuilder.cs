...
using Octokit.Client.Orgs.Item.Hooks.Item;
...
using System;
namespace Octokit.Client.Orgs.Item.Hooks {
    /// <summary>
    /// Builds and executes requests for operations under \orgs\{org}\hooks
    /// </summary>
    public class HooksRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.orgs.item.hooks.item collection</summary>
