...
using Octokit.Client.Orgs.Item.Hooks.Item.Deliveries.Item;
...
using System;
namespace Octokit.Client.Orgs.Item.Hooks.Item.Deliveries {
    /// <summary>
    ...
    public class DeliveriesRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.orgs.item.hooks.item.deliveries.item collection</summary>
