...
using Octokit.Client.App.Installations.Item;
...
using System;
namespace Octokit.Client.App.Installations {
    /// <summary>
    ...
    public class InstallationsRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.app.installations.item collection</summary>
