...
using Octokit.Client.App.Hook.Deliveries.Item;
...
using System;
namespace Octokit.Client.App.Hook.Deliveries {
    /// <summary>
    ...
    public class DeliveriesRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.app.hook.deliveries.item collection</summary>
