...
using Octokit.Client.Codes_of_conduct.Item;
...
using System;
namespace Octokit.Client.Codes_of_conduct {
    /// <summary>
    ...
    public class Codes_of_conductRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.codes_of_conduct.item collection</summary>
...
#nullable restore
        ...
        public class Codes_of_conductRequestBuilderGetRequestConfiguration : RequestConfiguration<DefaultQueryParameters> {
        }
    }
}
