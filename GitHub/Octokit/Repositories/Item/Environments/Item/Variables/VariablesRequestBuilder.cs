...
using Octokit.Client.Repositories.Item.Environments.Item.Variables.Item;
...
using System;
namespace Octokit.Client.Repositories.Item.Environments.Item.Variables {
    /// <summary>
    ...
    public class VariablesRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.repositories.item.environments.item.variables.item collection</summary>
