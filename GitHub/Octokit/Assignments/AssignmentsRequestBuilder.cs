...
using Octokit.Client.Assignments.Item;
using System.Collections.Generic;
using System.IO;
using System.Linq;
using System.Threading.Tasks;
using System;
namespace Octokit.Client.Assignments {
    /// <summary>
    /// Builds and executes requests for operations under \assignments
    /// </summary>
    public class AssignmentsRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Octokit.Client.assignments.item collection</summary>
