...
using Octokit.Client.Assignments.Item.Accepted_assignments;
using Octokit.Client.Assignments.Item.Grades;
...
using System;
namespace Octokit.Client.Assignments.Item {
    /// <summary>
...
#nullable restore
        ...
        public class WithAssignment_ItemRequestBuilderGetRequestConfiguration : RequestConfiguration<DefaultQueryParameters> {
        }
    }
}
